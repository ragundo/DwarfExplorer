...
namespace rdf
{
	enum class DF_Type
	{
		...
		specific_ref__T_data__T_UNIT_ITEM_WRESTLE,
		specific_ref_type,
		sphere_type,
		spoils_report,
		squad,
		...
		world__T_identities,
		world__T_image_sets,
		world__T_image_sets__T_all,
		world__T_image_sets__T_all__T_anon_3,
		world__T_incidents,
		...
		world_data__T_field_battles,
		world_data__T_field_battles__T_sapient_deaths,
