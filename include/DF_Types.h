...
Stl_fstream,
		...
		agreement,
		agreement__T_details,
		agreement__T_details__T_data,
		agreement__T_details__T_data__T_data0,
		agreement__T_details__T_data__T_data1,
		agreement__T_parties,
		agreement__T_parties__T_anon_1,
		ammo_flags,
		...
		historical_figure_info__T_relationships__T_anon_3,
		historical_figure_info__T_relationships__T_list,
		...
		history_event_artifact_claim_formedst__T_claim_type,
		...
		viewscreen_setupadventurest__T_background_type,
		viewscreen_setupadventurest__T_page,
		viewscreen_setupadventurest__T_races_info,
		viewscreen_setupadventurest__T_sel_trait_column,
