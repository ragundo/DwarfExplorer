...
extern void generate_musical_form_sub5_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_musical_form_sub1_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_musical_form_sub3_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_rhythm_sub1__T_anon_2_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_ui_advmode__T_unk_v44_1_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_historical_figure_info__T_secret__T_anon_2_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_historical_figure_info__T_secret__T_anon_8_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
void fill_offsets(DF_Type p_type, OffsetTable& p_table)
{
        switch (p_type)
        {
                ...
                case DF_Type::historical_figure_info__T_secret__T_anon_2 : generate_historical_figure_info__T_secret__T_anon_2_offsets(nullptr, p_table.m_offsets);break;
                case DF_Type::historical_figure_info__T_secret__T_anon_8 : generate_historical_figure_info__T_secret__T_anon_8_offsets(nullptr, p_table.m_offsets);break;
                ...
                case DF_Type::musical_form_sub1 : generate_musical_form_sub1_offsets(nullptr, p_table.m_offsets);break;
                case DF_Type::musical_form_sub3 : generate_musical_form_sub3_offsets(nullptr, p_table.m_offsets);break;
                case DF_Type::musical_form_sub4 : generate_musical_form_sub4_offsets(nullptr, p_table.m_offsets);break;
                case DF_Type::musical_form_sub5 : generate_musical_form_sub5_offsets(nullptr, p_table.m_offsets);break;
                ...
                case DF_Type::rhythm_sub1__T_anon_2 : generate_rhythm_sub1__T_anon_2_offsets(nullptr, p_table.m_offsets);break;
                ...
                case DF_Type::ui_advmode__T_unk_v44_1 : generate_ui_advmode__T_unk_v44_1_offsets(nullptr, p_table.m_offsets);break;
...
std::size_t OffsetsCache::get_offset(DF_Type p_type, std::string& p_field)
{
