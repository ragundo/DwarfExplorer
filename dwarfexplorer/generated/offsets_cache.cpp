...
extern void generate_unk_scale_enum_type_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_agreement_details_data_plot_sabotage_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_justification_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_identity_type_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_architectural_element_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_itemdef_flags_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_army_controller_villain_visiting_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_undead_flags_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_region_weather_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_interrogation_report_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_historical_entity__T_unknown2__T_unk28_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_historical_entity__T_unknown2__T_unk29_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_historical_figure__T_unk_v47_2_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_army_controller_invasion__T_anon_1_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_army_controller_invasion_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_army_controller_sub12__T_unk_4_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_specific_ref__T_data__T_wrestle_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_wound_curse_info__T_timing_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_breed__T_unk_8_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_breed__T_unk_18_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_breed__T_unk_28_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_breed_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_battlefield__T_sapient_deaths_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_battlefield_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_crime__T_convict_data_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_crime__T_victim_data_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
extern void generate_image_set__T_unk_vec1_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
extern void generate_image_set_offsets(void* p_df_structure, std::unordered_map<std::string, std::size_t>& p_table);
...
void fill_offsets(DF_Type p_type, OffsetTable& p_table)
{
	switch (p_type)
	{
		...
		case DF_Type::agreement_details_data_plot_sabotage : generate_agreement_details_data_plot_sabotage_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::army_controller_invasion : generate_army_controller_invasion_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::army_controller_invasion__T_anon_1 : generate_army_controller_invasion__T_anon_1_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::army_controller_sub12__T_unk_4 : generate_army_controller_sub12__T_unk_4_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::army_controller_villain_visiting : generate_army_controller_villain_visiting_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::battlefield : generate_battlefield_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::battlefield__T_sapient_deaths : generate_battlefield__T_sapient_deaths_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::breed : generate_breed_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::breed__T_unk_18 : generate_breed__T_unk_18_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::breed__T_unk_28 : generate_breed__T_unk_28_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::breed__T_unk_8 : generate_breed__T_unk_8_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::crime__T_convict_data : generate_crime__T_convict_data_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::crime__T_victim_data : generate_crime__T_victim_data_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::historical_entity__T_unknown2__T_unk28 : generate_historical_entity__T_unknown2__T_unk28_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::historical_entity__T_unknown2__T_unk29 : generate_historical_entity__T_unknown2__T_unk29_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::historical_figure__T_unk_v47_2 : generate_historical_figure__T_unk_v47_2_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::image_set : generate_image_set_offsets(nullptr, p_table.m_offsets);break;
		case DF_Type::image_set__T_unk_vec1 : generate_image_set__T_unk_vec1_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::interrogation_report : generate_interrogation_report_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::region_weather : generate_region_weather_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::specific_ref__T_data__T_wrestle : generate_specific_ref__T_data__T_wrestle_offsets(nullptr, p_table.m_offsets);break;
		...
		case DF_Type::wound_curse_info__T_timing : generate_wound_curse_info__T_timing_offsets(nullptr, p_table.m_offsets);break;
