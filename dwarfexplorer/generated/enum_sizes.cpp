...
DF_Type enum_base_type(DF_Type p_enum)
{
	switch(p_enum)
	{
		...
		case DF_Type::agreement_details_data_location__T_anon_5: return DF_Type::int32_t;
		...
		case DF_Type::historical_figure_info__T_relationships__T_unk__T_unk5__T_unk5_type: return DF_Type::int32_t;
		case DF_Type::unit_action__T_data__T_attack__T_unk_4__T_wrestle_type: return DF_Type::int32_t;
		...
		case DF_Type::incident__T_subtype: return DF_Type::int32_t;
...
std::pair<int,int> enum_min_max(DF_Type p_enum)
{
	switch(p_enum)
	{
		...
		case DF_Type::poetic_form_action: return std::pair<int,int>(0,22);
		...
		case DF_Type::creature_raw_flags: return std::pair<int,int>(0,116);
		...
		case DF_Type::agreement_details_type: return std::pair<int,int>(0,14);
		...
		case DF_Type::agreement_details_data_location__T_anon_5: return std::pair<int,int>(1,2);
		...
		case DF_Type::army_controller__T_type: return std::pair<int,int>(0,18);
		...
		case DF_Type::historical_figure_info__T_relationships__T_unk__T_unk5__T_unk5_type: return std::pair<int,int>(-1,15);
		case DF_Type::unit_action__T_data__T_attack__T_unk_4__T_wrestle_type: return std::pair<int,int>(0,1);
		...
		case DF_Type::incident__T_subtype: return std::pair<int,int>(0,6);
