...
DF_Type enum_base_type(DF_Type p_enum)
{
	switch(p_enum)
	{
		...
		case DF_Type::personality_facet_type: return DF_Type::int16_t;
...
std::pair<int,int> enum_min_max(DF_Type p_enum)
{
	switch(p_enum)
	{
		...
		case DF_Type::musical_form_style: return std::pair<int,int>(-1,71);
		case DF_Type::musical_form_pitch_style: return std::pair<int,int>(0,4);
