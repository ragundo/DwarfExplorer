...
std::tuple<int64_t, std::string, std::string> get_announcement_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 209: std::get<1>(result) = "CANNOT_CHOP_TREE"; std::get<2>(result) = "formerly TRAVEL_ADVISORY"; break;
		...
		case 325: std::get<1>(result) = "EMERGENCY_TACTICAL_CONTROL"; break;
		case 326: std::get<1>(result) = "AGREEMENT_SATISFIED"; break;
		case 327: std::get<1>(result) = "AGREEMENT_WARNING"; break;
		case 328: std::get<1>(result) = "AGREEMENT_ABANDONED"; break;
		case 329: std::get<1>(result) = "NEW_GUILD"; break;
		case 330: std::get<1>(result) = "CRIME_WITNESS_HANDOFF"; break;
		case 331: std::get<1>(result) = "CRIME_WITNESS_STOLEN"; break;
		case 332: std::get<1>(result) = "CRIME_WITNESS_ITEM_MOVED"; break;
		case 333: std::get<1>(result) = "CRIME_WITNESS_ITEM_MISSING"; break;
		case 334: std::get<1>(result) = "MOUNT"; break;
		case 335: std::get<1>(result) = "CANNOT_MOUNT"; break;
		case 336: std::get<1>(result) = "FAILED_MOUNT"; break;
		case 337: std::get<1>(result) = "DISMOUNT"; break;
		case 338: std::get<1>(result) = "FAILED_DISMOUNT"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_poetic_form_action_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 22: std::get<1>(result) = "Beseech"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_musical_form_style_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 45: std::get<1>(result) = "WithFeeling"; break;
		case 46: std::get<1>(result) = "FeelAgitated"; break;
		case 47: std::get<1>(result) = "BePassionate"; break;
		case 48: std::get<1>(result) = "Sparkle"; break;
		case 49: std::get<1>(result) = "BeBroad"; break;
		case 50: std::get<1>(result) = "BeMadeSweetly"; break;
		case 51: std::get<1>(result) = "BeStrong"; break;
		case 52: std::get<1>(result) = "BeEnergetic"; break;
		case 53: std::get<1>(result) = "BeForceful"; break;
		case 54: std::get<1>(result) = "FeelHeroic"; break;
		case 55: std::get<1>(result) = "BeMadeExpressively"; break;
		case 56: std::get<1>(result) = "FeelFurious"; break;
		case 57: std::get<1>(result) = "BeJoyful"; break;
		case 58: std::get<1>(result) = "BeGrand"; break;
		case 59: std::get<1>(result) = "BeMerry"; break;
		case 60: std::get<1>(result) = "BeGraceful"; break;
		case 61: std::get<1>(result) = "BuildAsItProceeds"; break;
		case 62: std::get<1>(result) = "EvokeTears"; break;
		case 63: std::get<1>(result) = "BeMelancholic"; break;
		case 64: std::get<1>(result) = "FeelMournful"; break;
		case 65: std::get<1>(result) = "BeMadeWithLightTouch"; break;
		case 66: std::get<1>(result) = "FeelHeavy"; break;
		case 67: std::get<1>(result) = "FeelMysterious"; break;
		case 68: std::get<1>(result) = "BeJumpy"; break;
		case 69: std::get<1>(result) = "FeelPlayful"; break;
		case 70: std::get<1>(result) = "FeelTender"; break;
		case 71: std::get<1>(result) = "FeelCalm"; break;
		case 72: std::get<1>(result) = "BeTriumphant"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_unk_scale_enum_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Unk_0"; break;
		case 1: std::get<1>(result) = "Unk_1"; break;
		case 2: std::get<1>(result) = "Unk_2"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_building_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 54: std::get<1>(result) = "OfferingPlace"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_creature_raw_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "EQUIPMENT"; std::get<2>(result) = "[EQUIPMENT_WAGON]"; break;
		case 1: std::get<1>(result) = "EQUIPMENT_WAGON"; std::get<2>(result) = "[EQUIPMENT_WAGON]"; break;
		case 2: std::get<1>(result) = "MUNDANE"; std::get<2>(result) = "[MUNDANE]"; break;
		case 3: std::get<1>(result) = "VERMIN_EATER"; std::get<2>(result) = "[VERMIN_EATER] and [PENETRATEPOWER]"; break;
		case 4: std::get<1>(result) = "VERMIN_GROUNDER"; std::get<2>(result) = "[VERMIN_GROUNDER]"; break;
		case 5: std::get<1>(result) = "VERMIN_ROTTER"; std::get<2>(result) = "[VERMIN_ROTTER]"; break;
		case 6: std::get<1>(result) = "VERMIN_SOIL"; std::get<2>(result) = "[VERMIN_SOIL]"; break;
		case 7: std::get<1>(result) = "VERMIN_SOIL_COLONY"; std::get<2>(result) = "[VERMIN_SOIL_COLONY]"; break;
		case 8: std::get<1>(result) = "LARGE_ROAMING"; std::get<2>(result) = "[LARGE_ROAMING]"; break;
		case 9: std::get<1>(result) = "VERMIN_FISH"; std::get<2>(result) = "[VERMIN_FISH]"; break;
		case 10: std::get<1>(result) = "LOOSE_CLUSTERS"; std::get<2>(result) = "[LOOSE_CLUSTERS]"; break;
		case 11: std::get<1>(result) = "FANCIFUL"; std::get<2>(result) = "[FANCIFUL]"; break;
		...
		case 63: std::get<1>(result) = "GOOD"; std::get<2>(result) = "[GOOD]"; break;
		case 64: std::get<1>(result) = "EVIL"; std::get<2>(result) = "[EVIL]"; break;
		case 65: std::get<1>(result) = "SAVAGE"; std::get<2>(result) = "[SAVAGE]"; break;
		case 66: std::get<1>(result) = "TWO_GENDERS"; break;
		case 67: std::get<1>(result) = "MATES_TO_BREED"; std::get<2>(result) = "capable of breeding, [MALE] and [FEMALE] tags"; break;
		case 68: std::get<1>(result) = "HAS_MALE"; std::get<2>(result) = "[MALE]"; break;
		case 69: std::get<1>(result) = "HAS_FEMALE"; std::get<2>(result) = "[FEMALE]"; break;
		case 70: std::get<1>(result) = "SMALL_RACE"; std::get<2>(result) = "any vermin"; break;
		case 71: std::get<1>(result) = "HAS_ANY_INTELLIGENT_LEARNS"; break;
		case 72: std::get<1>(result) = "HAS_ANY_VERMIN_HATEABLE"; std::get<2>(result) = "[VERMIN_HATEABLE]"; break;
		case 73: std::get<1>(result) = "OCCURS_AS_ENTITY_RACE"; std::get<2>(result) = "included in entity_defaults.txt"; break;
		case 74: std::get<1>(result) = "HAS_ANY_LARGE_PREDATOR"; std::get<2>(result) = "[LARGE_PREDATOR]"; break;
		case 75: std::get<1>(result) = "HAS_ANY_CURIOUS_BEAST"; break;
		case 76: std::get<1>(result) = "HAS_ANY_BENIGN"; std::get<2>(result) = "[BENIGN]"; break;
		case 77: std::get<1>(result) = "HAS_ANY_NATURAL_ANIMAL"; std::get<2>(result) = "[NATURAL]"; break;
		case 78: std::get<1>(result) = "HAS_ANY_MEGABEAST"; std::get<2>(result) = "[MEGABEAST]"; break;
		case 79: std::get<1>(result) = "HAS_ANY_SEMIMEGABEAST"; std::get<2>(result) = "[SEMIMEGABEAST]"; break;
		case 80: std::get<1>(result) = "HAS_ANY_POWER"; break;
		case 81: std::get<1>(result) = "HAS_ANY_VERMIN_MICRO"; std::get<2>(result) = "[VERMIN_MICRO]"; break;
		case 82: std::get<1>(result) = "HAS_ANY_NOT_FIREIMMUNE"; break;
		case 83: std::get<1>(result) = "HAS_ANY_CANNOT_BREATHE_WATER"; break;
		case 84: std::get<1>(result) = "HAS_ANY_CANNOT_BREATHE_AIR"; std::get<2>(result) = "[AQUATIC]"; break;
		case 85: std::get<1>(result) = "HAS_ANY_NOT_FLIER"; break;
		case 86: std::get<1>(result) = "HAS_ANY_CAN_SWIM"; break;
		case 87: std::get<1>(result) = "HAS_ANY_COMMON_DOMESTIC"; std::get<2>(result) = "[COMMON_DOMESTIC]"; break;
		case 88: std::get<1>(result) = "HAS_ANY_UTTERANCES"; std::get<2>(result) = "[UTTERANCES]"; break;
		case 89: std::get<1>(result) = "HAS_ANY_INTELLIGENT_SPEAKS"; break;
		case 90: std::get<1>(result) = "HAS_ANY_FEATURE_BEAST"; std::get<2>(result) = "[FEATURE_BEAST]"; break;
		case 91: std::get<1>(result) = "GENERATED"; std::get<2>(result) = "[GENERATED]"; break;
		case 92: std::get<1>(result) = "HAS_ANY_TITAN"; std::get<2>(result) = "[TITAN]"; break;
		case 93: std::get<1>(result) = "HAS_ANY_UNIQUE_DEMON"; std::get<2>(result) = "[UNIQUE_DEMON]"; break;
		case 94: std::get<1>(result) = "DOES_NOT_EXIST"; std::get<2>(result) = "[DOES_NOT_EXIST]"; break;
		case 95: std::get<1>(result) = "HAS_ANY_NOT_LIVING"; std::get<2>(result) = "[NOT_LIVING]"; break;
		case 96: std::get<1>(result) = "HAS_ANY_MISCHIEVOUS"; std::get<2>(result) = "[MISCHIEVOUS], the flag used internally is actually HAS_ANY_MISCHIEVIOUS"; break;
		case 97: std::get<1>(result) = "HAS_ANY_FLIER"; std::get<2>(result) = "[FLIER]"; break;
		case 98: std::get<1>(result) = "HAS_ANY_DEMON"; break;
		case 99: std::get<1>(result) = "HAS_ANY_NIGHT_CREATURE"; break;
		case 100: std::get<1>(result) = "HAS_ANY_NIGHT_CREATURE_HUNTER"; std::get<2>(result) = "[NIGHT_CREATURE_HUNTER]"; break;
		case 101: std::get<1>(result) = "HAS_ANY_NIGHT_CREATURE_BOGEYMAN"; std::get<2>(result) = "[NIGHT_CREATURE_BOGEYMAN]"; break;
		case 102: std::get<1>(result) = "HAS_ANY_CARNIVORE"; break;
		case 103: std::get<1>(result) = "ARTIFICIAL_HIVEABLE"; std::get<2>(result) = "[ARTIFICIAL_HIVEABLE]"; break;
		case 104: std::get<1>(result) = "UBIQUITOUS"; std::get<2>(result) = "[UBIQUITOUS]"; break;
		case 105: std::get<1>(result) = "ALL_CASTES_ALIVE"; std::get<2>(result) = "does not have [NOT_LIVING] tag"; break;
		case 106: std::get<1>(result) = "HAS_ANY_SUPERNATURAL"; std::get<2>(result) = "[SUPERNATURAL]"; break;
		case 107: std::get<1>(result) = "HAS_ANY_HAS_BLOOD"; std::get<2>(result) = "[BLOOD]"; break;
		case 108: std::get<1>(result) = "HAS_ANY_GRAZER"; std::get<2>(result) = "[STANDARD_GRAZER]"; break;
		case 109: std::get<1>(result) = "HAS_ANY_IMMOBILE"; std::get<2>(result) = "[IMMOBILE]"; break;
		case 110: std::get<1>(result) = "HAS_ANY_LOCAL_POPS_CONTROLLABLE"; std::get<2>(result) = "[LOCAL_POPS_CONTROLLABLE]"; break;
		case 111: std::get<1>(result) = "HAS_ANY_OUTSIDER_CONTROLLABLE"; std::get<2>(result) = "[OUTSIDER_CONTROLLABLE]"; break;
		case 112: std::get<1>(result) = "HAS_ANY_LOCAL_POPS_PRODUCE_HEROES"; std::get<2>(result) = "[LOCAL_POPS_PRODUCE_HEROES]"; break;
		case 113: std::get<1>(result) = "HAS_ANY_GRASP"; break;
		case 114: std::get<1>(result) = "HAS_ANY_RACE_GAIT"; break;
		case 115: std::get<1>(result) = "HAS_ANY_FLY_RACE_GAIT"; std::get<2>(result) = "[FLIER]"; break;
		case 116: std::get<1>(result) = "HAS_ANY_SLOW_LEARNER"; break;
		case 117: std::get<1>(result) = "HAS_ANY_NIGHT_CREATURE_NIGHTMARE"; break;
		case 118: std::get<1>(result) = "HAS_ANY_NIGHT_CREATURE_EXPERIMENTER"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_caste_raw_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "CAN_BREATHE_WATER"; break;
		case 1: std::get<1>(result) = "CANNOT_BREATHE_AIR"; break;
		case 2: std::get<1>(result) = "LOCKPICKER"; break;
		case 3: std::get<1>(result) = "MISCHIEVOUS"; std::get<2>(result) = "the flag used internally is actually MISCHIEVIOUS"; break;
		case 4: std::get<1>(result) = "PATTERNFLIER"; break;
		case 5: std::get<1>(result) = "CURIOUS_BEAST"; break;
		case 6: std::get<1>(result) = "CURIOUS_BEAST_ITEM"; break;
		case 7: std::get<1>(result) = "CURIOUS_BEAST_GUZZLER"; break;
		case 8: std::get<1>(result) = "FLEEQUICK"; break;
		case 9: std::get<1>(result) = "AT_PEACE_WITH_WILDLIFE"; break;
		case 10: std::get<1>(result) = "CAN_SWIM"; break;
		case 11: std::get<1>(result) = "OPPOSED_TO_LIFE"; break;
		case 12: std::get<1>(result) = "CURIOUS_BEAST_EATER"; break;
		...
		case 48: std::get<1>(result) = "HAS_SECRETION"; break;
		...
		case 56: std::get<1>(result) = "HAS_ROTTABLE"; break;
		case 57: std::get<1>(result) = "CAN_SPEAK"; std::get<2>(result) = "aka INTELLIGENT_SPEAKS"; break;
		case 58: std::get<1>(result) = "CAN_LEARN"; std::get<2>(result) = "aka INTELLIGENT_LEARNS"; break;
		case 59: std::get<1>(result) = "UTTERANCES"; break;
		case 60: std::get<1>(result) = "BONECARN"; break;
		case 61: std::get<1>(result) = "CARNIVORE"; break;
		case 62: std::get<1>(result) = "AQUATIC_UNDERSWIM"; break;
		...
		case 69: std::get<1>(result) = "HAS_BLOOD"; break;
		...
		case 74: std::get<1>(result) = "HAS_PUS"; break;
		...
		case 92: std::get<1>(result) = "GELDABLE"; std::get<2>(result) = "previously LIKES_FIGHTING"; break;
		...
		case 96: std::get<1>(result) = "NATURAL_ANIMAL"; break;
		case 97: std::get<1>(result) = "HAS_BABYSTATE"; break;
		case 98: std::get<1>(result) = "HAS_CHILDSTATE"; break;
		...
		case 121: std::get<1>(result) = "HAS_SOLDIER_TILE"; break;
		case 122: std::get<1>(result) = "ALCOHOL_DEPENDENT"; break;
		case 123: std::get<1>(result) = "CAN_SWIM_INNATE"; break;
		case 124: std::get<1>(result) = "POWER"; break;
		case 125: std::get<1>(result) = "TENDONS"; break;
		case 126: std::get<1>(result) = "LIGAMENTS"; break;
		case 127: std::get<1>(result) = "HAS_TILE"; break;
		case 128: std::get<1>(result) = "HAS_COLOR"; break;
		case 129: std::get<1>(result) = "HAS_GLOW_TILE"; break;
		case 130: std::get<1>(result) = "HAS_GLOW_COLOR"; break;
		...
		case 143: std::get<1>(result) = "NIGHT_CREATURE"; break;
		...
		case 156: std::get<1>(result) = "HAS_SOUND_ALERT"; break;
		case 157: std::get<1>(result) = "HAS_SOUND_PEACEFUL_INTERMITTENT"; break;
		...
		case 165: std::get<1>(result) = "VERMIN_GOBBLER"; break;
		...
		case 173: std::get<1>(result) = "HAS_GRASP"; break;
		case 174: std::get<1>(result) = "HAS_FLY_RACE_GAIT"; break;
		case 175: std::get<1>(result) = "HAS_RACE_GAIT"; break;
		case 176: std::get<1>(result) = "NIGHT_CREATURE_NIGHTMARE"; break;
		case 177: std::get<1>(result) = "NIGHT_CREATURE_EXPERIMENTER"; break;
		case 178: std::get<1>(result) = "SPREAD_EVIL_SPHERES_IF_RULER"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_historical_entity_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 9: std::get<1>(result) = "MerchantCompany"; break;
		case 10: std::get<1>(result) = "Guild"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_crime_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Bribery"; break;
		case 1: std::get<1>(result) = "anon_1"; break;
		case 2: std::get<1>(result) = "Treason"; break;
		case 3: std::get<1>(result) = "Embezzlement"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_agreement_details_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "JoinParty"; break;
		case 1: std::get<1>(result) = "DemonicBinding"; break;
		case 2: std::get<1>(result) = "Residency"; break;
		case 3: std::get<1>(result) = "Citizenship"; break;
		case 4: std::get<1>(result) = "Parley"; break;
		case 5: std::get<1>(result) = "PositionCorruption"; std::get<2>(result) = "Embezzlement and accepting bribes seen. For own gain and for 'sponsor'"; break;
		case 6: std::get<1>(result) = "PlotStealArtifact"; break;
		case 7: std::get<1>(result) = "PromisePosition"; break;
		case 8: std::get<1>(result) = "PlotAssassination"; break;
		case 9: std::get<1>(result) = "PlotAbduct"; break;
		case 10: std::get<1>(result) = "PlotSabotage"; break;
		case 11: std::get<1>(result) = "PlotConviction"; break;
		case 12: std::get<1>(result) = "Location"; break;
		case 13: std::get<1>(result) = "PlotInfiltrationCoup"; break;
		case 14: std::get<1>(result) = "PlotFrameTreason"; break;
		case 15: std::get<1>(result) = "PlotInduceWar"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_entity_name_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 16: std::get<1>(result) = "MERCHANT_COMPANY"; break;
		case 17: std::get<1>(result) = "CRAFT_GUILD"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_entity_position_responsibility_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 25: std::get<1>(result) = "ESPIONAGE"; break;
		case 26: std::get<1>(result) = "ADVISE_LEADERS"; break;
		case 27: std::get<1>(result) = "OVERSEE_LEADER_HOUSEHOLD"; break;
		case 28: std::get<1>(result) = "MANAGE_ANIMALS"; break;
		case 29: std::get<1>(result) = "MANAGE_LEADER_HOUSEHOLD_FOOD"; break;
		case 30: std::get<1>(result) = "MANAGE_LEADER_HOUSEHOLD_DRINKS"; break;
		case 31: std::get<1>(result) = "PREPARE_LEADER_MEALS"; break;
		case 32: std::get<1>(result) = "MANAGE_LEADER_HOUSEHOLD_CLEANLINESS"; break;
		case 33: std::get<1>(result) = "MAINTAIN_SEWERS"; break;
		case 34: std::get<1>(result) = "FOOD_SUPPLY"; break;
		case 35: std::get<1>(result) = "FIRE_SAFETY"; break;
		case 36: std::get<1>(result) = "JUDGE"; break;
		case 37: std::get<1>(result) = "BUILDING_SAFETY"; break;
		case 38: std::get<1>(result) = "CONSTRUCTION_PERMITS"; break;
		case 39: std::get<1>(result) = "MAINTAIN_ROADS"; break;
		case 40: std::get<1>(result) = "MAINTAIN_BRIDGES"; break;
		case 41: std::get<1>(result) = "MAINTAIN_TUNNELS"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_next_global_id_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "unit"; break;
		case 1: std::get<1>(result) = "soul"; break;
		case 2: std::get<1>(result) = "item"; break;
		case 3: std::get<1>(result) = "civ"; break;
		case 4: std::get<1>(result) = "nem"; break;
		case 5: std::get<1>(result) = "artifact"; break;
		case 6: std::get<1>(result) = "job"; break;
		case 7: std::get<1>(result) = "schedule"; break;
		case 8: std::get<1>(result) = "proj"; break;
		case 9: std::get<1>(result) = "building"; break;
		case 10: std::get<1>(result) = "machine"; break;
		case 11: std::get<1>(result) = "flow_guide"; break;
		case 12: std::get<1>(result) = "histfig"; break;
		case 13: std::get<1>(result) = "histevent"; break;
		case 14: std::get<1>(result) = "histeventcol"; break;
		case 15: std::get<1>(result) = "unitchunk"; break;
		case 16: std::get<1>(result) = "imagechunk"; break;
		case 17: std::get<1>(result) = "task"; break;
		case 18: std::get<1>(result) = "squad"; break;
		case 19: std::get<1>(result) = "formation"; break;
		case 20: std::get<1>(result) = "activity"; break;
		case 21: std::get<1>(result) = "interaction_instance"; break;
		case 22: std::get<1>(result) = "written_content"; break;
		case 23: std::get<1>(result) = "identity"; break;
		case 24: std::get<1>(result) = "incident"; break;
		case 25: std::get<1>(result) = "crime"; break;
		case 26: std::get<1>(result) = "vehicle"; break;
		case 27: std::get<1>(result) = "army"; break;
		case 28: std::get<1>(result) = "army_controller"; break;
		case 29: std::get<1>(result) = "army_tracking_info"; break;
		case 30: std::get<1>(result) = "cultural_identity"; break;
		case 31: std::get<1>(result) = "agreement"; break;
		case 32: std::get<1>(result) = "poetic_form"; break;
		case 33: std::get<1>(result) = "musical_form"; break;
		case 34: std::get<1>(result) = "dance_form"; break;
		case 35: std::get<1>(result) = "scale"; break;
		case 36: std::get<1>(result) = "rhythm"; break;
		case 37: std::get<1>(result) = "occupation"; break;
		case 38: std::get<1>(result) = "belief_system"; break;
		case 39: std::get<1>(result) = "image_set"; break;
		case 40: std::get<1>(result) = "divination_set"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_lever_target_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 108: std::get<1>(result) = "LeverMechanism"; std::get<2>(result) = "use in lever"; break;
		case 115: std::get<1>(result) = "Support"; break;
		case 116: std::get<1>(result) = "TargetMechanism"; std::get<2>(result) = "use in target"; break;
...
std::tuple<int64_t, std::string, std::string> get_justification_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "justify_left"; break;
		case 1: std::get<1>(result) = "justify_center"; break;
		case 2: std::get<1>(result) = "justify_right"; break;
		case 3: std::get<1>(result) = "justify_cont"; break;
		case 4: std::get<1>(result) = "not_truetype"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_whereabouts_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "NONE"; break;
		case 0: std::get<1>(result) = "wanderer"; std::get<2>(result) = "wandering the wilds/region/depths of the world (none/region/underground_region)"; break;
		case 1: std::get<1>(result) = "settler"; std::get<2>(result) = "site/region, region only for dead 'monsters'"; break;
		case 2: std::get<1>(result) = "refugee"; std::get<2>(result) = "into region only for dead. refugees and abucted-imprisoned-turned"; break;
		case 3: std::get<1>(result) = "army_died"; std::get<2>(result) = "either no record of participation in battle, or character died and defender won (character on either side)"; break;
		case 4: std::get<1>(result) = "army_survived"; std::get<2>(result) = "either no record of participation in battle, or character survived and defender won (character on either side)"; break;
		case 5: std::get<1>(result) = "visitor"; std::get<2>(result) = "'visited' as last movement seems to be the key"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_death_condition_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "no_statement"; std::get<2>(result) = "alive or dead, but death conditions not registered here"; break;
		case 1: std::get<1>(result) = "site_battle"; std::get<2>(result) = "parameters: site id + optional structure"; break;
		case 2: std::get<1>(result) = "region_battle"; std::get<2>(result) = "parameters: two unknown values, usually small, with same pair being the same region, but neither is region_id"; break;
		case 3: std::get<1>(result) = "wilderness"; std::get<2>(result) = "parameters: region_id + -1"; break;
		case 4: std::get<1>(result) = "anon_1"; break;
		case 5: std::get<1>(result) = "entombed"; std::get<2>(result) = "same parameters as for site_battle, but structure seems to always be present and be a tomb"; break;
		case 6: std::get<1>(result) = "site"; std::get<2>(result) = "same parameters as for site_battle, old age and deadly confrontation seen"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_plot_role_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Possible_Threat"; break;
		case 1: std::get<1>(result) = "Rebuffed"; break;
		case 2: std::get<1>(result) = "Source_Of_Funds"; break;
		case 3: std::get<1>(result) = "Source_Of_Funds_For_Master"; break;
		case 4: std::get<1>(result) = "Master"; break;
		case 5: std::get<1>(result) = "Suspected_Criminal"; break;
		case 6: std::get<1>(result) = "Asset"; break;
		case 7: std::get<1>(result) = "Lieutenant"; break;
		case 8: std::get<1>(result) = "Usable_Thief"; break;
		case 9: std::get<1>(result) = "Potential_Employer"; break;
		case 10: std::get<1>(result) = "Indirect_Director"; std::get<2>(result) = "Seen as 'possibly unknown director' in actor's exported XML when influencing the plotter using an intermediary in Legends Mode"; break;
		case 11: std::get<1>(result) = "Corrupt_Position_Holder"; break;
		case 12: std::get<1>(result) = "Delivery_Target"; break;
		case 13: std::get<1>(result) = "Handler"; break;
		case 14: std::get<1>(result) = "Usable_Assassin"; break;
		case 15: std::get<1>(result) = "Director"; std::get<2>(result) = "Seen with no role or 'potential employer' in actor's exported XML, and as the one influencing the plotter in Legends Mode"; break;
		case 16: std::get<1>(result) = "Enemy"; break;
		case 17: std::get<1>(result) = "Usable_Snatcher"; break;
		case 18: std::get<1>(result) = "anon_1"; break;
		case 19: std::get<1>(result) = "anon_2"; break;
		case 20: std::get<1>(result) = "Underworld_Contact"; break;
		case 21: std::get<1>(result) = "Possibly_Unknown_Director"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_plot_strategy_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Corrupt_And_Pacify"; break;
		case 1: std::get<1>(result) = "Obey"; break;
		case 2: std::get<1>(result) = "Avoid"; break;
		case 3: std::get<1>(result) = "Use"; break;
		case 4: std::get<1>(result) = "Tax"; break;
		case 5: std::get<1>(result) = "Neutralize"; break;
		case 6: std::get<1>(result) = "Monitor"; break;
		case 7: std::get<1>(result) = "Work_If_Suited"; break;
		case 8: std::get<1>(result) = "Torment"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_vague_relationship_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "childhood_friend"; break;
		case 1: std::get<1>(result) = "war_buddy"; break;
		case 2: std::get<1>(result) = "jealous_obsession"; break;
		case 3: std::get<1>(result) = "jealous_relationship_grudge"; break;
		case 4: std::get<1>(result) = "lover"; break;
		case 5: std::get<1>(result) = "former_lover"; std::get<2>(result) = "broke up"; break;
		case 6: std::get<1>(result) = "scholar_buddy"; break;
		case 7: std::get<1>(result) = "artistic_buddy"; break;
		case 8: std::get<1>(result) = "athlete_buddy"; break;
		case 9: std::get<1>(result) = "atheletic_rival"; break;
		case 10: std::get<1>(result) = "business_rival"; break;
		case 11: std::get<1>(result) = "religious_persecution_grudge"; break;
		case 12: std::get<1>(result) = "grudge"; break;
		case 13: std::get<1>(result) = "persecution_grudge"; break;
		case 14: std::get<1>(result) = "supernatural_grudge"; break;
		case 15: std::get<1>(result) = "lieutenant"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_identity_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "HidingCurse"; std::get<2>(result) = "Inferred from Units.cpp after examining code using 'unk_4c'"; break;
		case 1: std::get<1>(result) = "Unk_1"; std::get<2>(result) = "Not seen. A guess is that it might have been used by deities under cover"; break;
		case 2: std::get<1>(result) = "TrueName"; std::get<2>(result) = "E.g. of demonic overlords. Can be used by adventurers to gain sway over them"; break;
		case 3: std::get<1>(result) = "FalseIdentity"; std::get<2>(result) = "For underhanded purposes"; break;
		case 4: std::get<1>(result) = "Unk_4"; break;
		case 5: std::get<1>(result) = "Identity"; std::get<2>(result) = "Claim a new official identity, seen when religious appointments are received"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 113: std::get<1>(result) = "TRADE"; break;
		case 114: std::get<1>(result) = "ADD_ENTITY_SITE_PROFILE_FLAG"; break;
		case 115: std::get<1>(result) = "GAMBLE"; break;
		case 116: std::get<1>(result) = "ADD_HF_ENTITY_HONOR"; break;
		case 117: std::get<1>(result) = "ENTITY_DISSOLVED"; break;
		case 118: std::get<1>(result) = "ENTITY_EQUIPMENT_PURCHASE"; break;
		case 119: std::get<1>(result) = "MODIFIED_BUILDING"; break;
		case 120: std::get<1>(result) = "BUILDING_PROFILE_ACQUIRED"; break;
		case 121: std::get<1>(result) = "HF_PREACH"; break;
		case 122: std::get<1>(result) = "ENTITY_PERSECUTED"; break;
		case 123: std::get<1>(result) = "ENTITY_BREACH_FEATURE_LAYER"; break;
		case 124: std::get<1>(result) = "ENTITY_ALLIANCE_FORMED"; break;
		case 125: std::get<1>(result) = "HF_RANSOMED"; break;
		case 126: std::get<1>(result) = "HF_ENSLAVED"; break;
		case 127: std::get<1>(result) = "SABOTAGE"; break;
		case 128: std::get<1>(result) = "ENTITY_OVERTHROWN"; break;
		case 129: std::get<1>(result) = "HFS_FORMED_INTRIGUE_RELATIONSHIP"; break;
		case 130: std::get<1>(result) = "FAILED_INTRIGUE_CORRUPTION"; break;
		case 131: std::get<1>(result) = "HF_CONVICTED"; break;
		case 132: std::get<1>(result) = "FAILED_FRAME_ATTEMPT"; break;
		case 133: std::get<1>(result) = "HF_INTERROGATED"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_reason_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 78: std::get<1>(result) = "fear_of_persecution"; std::get<2>(result) = "The ones below were introduced in 0.47.01 as well"; break;
		case 79: std::get<1>(result) = "smooth_operation"; break;
		case 80: std::get<1>(result) = "nuance_belief"; break;
		case 81: std::get<1>(result) = "shared_interest"; break;
		case 82: std::get<1>(result) = "envy_living"; break;
		case 83: std::get<1>(result) = "death_panic"; break;
		case 84: std::get<1>(result) = "death_fear"; break;
		case 85: std::get<1>(result) = "avoid_judgement"; break;
		case 86: std::get<1>(result) = "death_pride"; break;
		case 87: std::get<1>(result) = "death_vain"; break;
		case 88: std::get<1>(result) = "death_ambition"; break;
		case 89: std::get<1>(result) = "lack_of_funds"; break;
		case 90: std::get<1>(result) = "battle_losses"; break;
		case 91: std::get<1>(result) = "conviction_exile"; break;
		case 92: std::get<1>(result) = "priest_vent"; break;
		case 93: std::get<1>(result) = "priest_cry"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_architectural_element_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "NONE"; break;
		case 0: std::get<1>(result) = "paved_outdoor_area"; break;
		case 1: std::get<1>(result) = "uneven_pillars"; break;
		case 2: std::get<1>(result) = "square_of_pillars"; break;
		case 3: std::get<1>(result) = "pillars_on_the_perimeter"; break;
		case 4: std::get<1>(result) = "upper_floors"; break;
		case 5: std::get<1>(result) = "lower_floors"; break;
		case 6: std::get<1>(result) = "water_pool"; break;
		case 7: std::get<1>(result) = "lava_pool"; break;
		case 8: std::get<1>(result) = "stagnant_pool"; break;
		case 9: std::get<1>(result) = "open_structure"; break;
		case 10: std::get<1>(result) = "paved_indoor_areas"; break;
		case 11: std::get<1>(result) = "detailed_surfaces"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_history_event_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "hidden"; std::get<2>(result) = "event is hidden from legends mode when this is set"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_history_event_war_attacked_sitest__T_unk_1_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_death_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 54: std::get<1>(result) = "EXECUTION_GENERIC"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_hist_figure_woundedst__T_injury_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 4: std::get<1>(result) = "Burn"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_simple_battle_subtype_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 10: std::get<1>(result) = "SUBDUED"; break;
		case 11: std::get<1>(result) = "GOT_INTO_A_BRAWL"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_artifact_claim_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_history_event_collection_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 16: std::get<1>(result) = "PERSECUTION"; break;
		case 17: std::get<1>(result) = "ENTITY_OVERTHROWN"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_interaction_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "GENERATED"; break;
		case 1: std::get<1>(result) = "EXPERIMENT_ONLY"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_interaction_effect_location_hint_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 4: std::get<1>(result) = "NO_THICK_FOG"; break;
		case 5: std::get<1>(result) = "OUTSIDE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_interaction_source_usage_hint_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 8: std::get<1>(result) = "DEFEND"; break;
		case 9: std::get<1>(result) = "MEDIUM_CURSE"; break;
		case 10: std::get<1>(result) = "MINOR_CURSE"; break;
		case 11: std::get<1>(result) = "MEDIUM_BLESSING"; break;
		case 12: std::get<1>(result) = "MINOR_BLESSING"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_interaction_target_location_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 6: std::get<1>(result) = "RANDOM_NEARBY_LOCATION"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_breath_attack_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 20: std::get<1>(result) = "SHARP_ROCK"; break;
		case 21: std::get<1>(result) = "OTHER"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_itemdef_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_tool_uses_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 23: std::get<1>(result) = "PLACE_OFFERING"; break;
		case 24: std::get<1>(result) = "DIVINATION"; break;
		case 25: std::get<1>(result) = "GAMES_OF_CHANCE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_job_item_vector_id_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 130: std::get<1>(result) = "anon_1"; break;
		case 131: std::get<1>(result) = "anon_2"; break;
		case 132: std::get<1>(result) = "anon_3"; std::get<2>(result) = "Observed for sheet on scroll making job. Could 'BOOK' have been displaced?"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_interface_key_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 318: std::get<1>(result) = "A_CONV_PERSUADE"; break;
		case 319: std::get<1>(result) = "A_CONV_INTIMIDATE"; break;
		case 320: std::get<1>(result) = "A_ASSUME_IDENTITY_NEW"; break;
		case 321: std::get<1>(result) = "A_ASSUME_IDENTITY_NONE"; break;
		case 322: std::get<1>(result) = "A_ASSUME_IDENTITY_NAME"; break;
		case 323: std::get<1>(result) = "A_ASSUME_IDENTITY_ORIGIN"; break;
		case 324: std::get<1>(result) = "A_ASSUME_IDENTITY_PROFESSION"; break;
		case 325: std::get<1>(result) = "A_ASSUME_IDENTITY_WORSHIP"; break;
		case 326: std::get<1>(result) = "A_INTERACT"; break;
		case 327: std::get<1>(result) = "A_ACTION"; break;
		case 328: std::get<1>(result) = "A_ACTION_CREATE"; break;
		case 329: std::get<1>(result) = "A_ACTION_BUTCHER"; break;
		case 330: std::get<1>(result) = "A_ACTION_ABILITY"; break;
		case 331: std::get<1>(result) = "A_ACTION_POWER"; break;
		case 332: std::get<1>(result) = "A_ACTION_COMPOSE"; break;
		case 333: std::get<1>(result) = "A_ACTION_WRITE"; break;
		case 334: std::get<1>(result) = "A_CONSTRUCTION"; break;
		case 335: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_NEW"; break;
		case 336: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_EDIT"; break;
		case 337: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_ASSIGN"; break;
		case 338: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_DELETE"; break;
		case 339: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_RECT"; break;
		case 340: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_FLOW"; break;
		case 341: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE_REMOVE_RECT"; break;
		case 342: std::get<1>(result) = "ADV_CONSTRUCTION_STAIR_UPDOWN"; break;
		case 343: std::get<1>(result) = "ADV_CONSTRUCTION_REMOVE_PLANS"; break;
		case 344: std::get<1>(result) = "ADV_CONSTRUCTION_REMOVE_EXISTING"; break;
		case 345: std::get<1>(result) = "ADV_CONSTRUCTION_MATERIAL"; break;
		case 346: std::get<1>(result) = "ADV_CONSTRUCTION_CONSTRUCTION"; break;
		case 347: std::get<1>(result) = "ADV_CONSTRUCTION_BUILDING"; break;
		case 348: std::get<1>(result) = "ADV_CONSTRUCTION_ZONE"; break;
		case 349: std::get<1>(result) = "ADV_CONSTRUCTION_WORK_MENU"; break;
		case 350: std::get<1>(result) = "ADV_CONSTRUCTION_NAME_SITE"; break;
		case 351: std::get<1>(result) = "ADV_CONSTRUCTION_YOU_WORK"; break;
		case 352: std::get<1>(result) = "ADV_CONSTRUCTION_START"; break;
		case 353: std::get<1>(result) = "A_COMPOSE_FILTER"; break;
		case 354: std::get<1>(result) = "A_INV_LOOK"; break;
		case 355: std::get<1>(result) = "A_INV_REMOVE"; break;
		case 356: std::get<1>(result) = "A_INV_WEAR"; break;
		case 357: std::get<1>(result) = "A_INV_EATDRINK"; break;
		case 358: std::get<1>(result) = "A_INV_PUTIN"; break;
		case 359: std::get<1>(result) = "A_INV_DROP"; break;
		case 360: std::get<1>(result) = "A_GROUND"; break;
		case 361: std::get<1>(result) = "A_THROW"; break;
		case 362: std::get<1>(result) = "A_SHOOT"; break;
		case 363: std::get<1>(result) = "A_ANNOUNCEMENTS"; break;
		case 364: std::get<1>(result) = "A_COMBAT"; break;
		case 365: std::get<1>(result) = "A_TACTICAL_SETTINGS"; break;
		case 366: std::get<1>(result) = "A_MOVEMENT"; break;
		case 367: std::get<1>(result) = "A_MOVEMENT_SWIM"; break;
		case 368: std::get<1>(result) = "A_SNEAK"; break;
		case 369: std::get<1>(result) = "A_SPEED_SNEAK"; break;
		case 370: std::get<1>(result) = "A_CENTER"; break;
		case 371: std::get<1>(result) = "A_COMPANIONS"; break;
		case 372: std::get<1>(result) = "A_BUILDING"; break;
		case 373: std::get<1>(result) = "A_TRAVEL"; break;
		case 374: std::get<1>(result) = "A_TRAVEL_SLEEP"; break;
		case 375: std::get<1>(result) = "A_TRAVEL_MAP"; break;
		case 376: std::get<1>(result) = "A_TRAVEL_HIDE_INSTRUCTIONS"; break;
		case 377: std::get<1>(result) = "A_DATE"; break;
		case 378: std::get<1>(result) = "A_WEATHER"; break;
		case 379: std::get<1>(result) = "A_TEMPERATURE"; break;
		case 380: std::get<1>(result) = "A_STANCE"; break;
		case 381: std::get<1>(result) = "CSHEET_BACKGROUND"; break;
		case 382: std::get<1>(result) = "CSHEET_NEW_CHARACTER"; break;
		case 383: std::get<1>(result) = "CSHEET_SKILLS"; break;
		case 384: std::get<1>(result) = "CSHEET_APPEARANCE"; break;
		case 385: std::get<1>(result) = "CSHEET_PERSONALITY"; break;
		case 386: std::get<1>(result) = "CSHEET_EQUIPMENT"; break;
		case 387: std::get<1>(result) = "CSHEET_PETS"; break;
		case 388: std::get<1>(result) = "CSHEET_RANDOMIZE_BACKGROUND"; break;
		case 389: std::get<1>(result) = "CSHEET_SELECT_BACKGROUND_OPTION"; break;
		case 390: std::get<1>(result) = "CSHEET_WORSHIP_UP"; break;
		case 391: std::get<1>(result) = "CSHEET_WORSHIP_DOWN"; break;
		case 392: std::get<1>(result) = "CSHEET_NEW_ITEM"; break;
		case 393: std::get<1>(result) = "CSHEET_QUALITY_UP"; break;
		case 394: std::get<1>(result) = "CSHEET_QUALITY_DOWN"; break;
		case 395: std::get<1>(result) = "CSHEET_NAME_PET"; break;
		case 396: std::get<1>(result) = "CSHEET_REMOVE_PET"; break;
		case 397: std::get<1>(result) = "CSHEET_ADD_PET"; break;
		case 398: std::get<1>(result) = "A_ENTER_NAME"; break;
		case 399: std::get<1>(result) = "A_CUST_NAME"; break;
		case 400: std::get<1>(result) = "A_RANDOM_NAME"; break;
		case 401: std::get<1>(result) = "A_RANDOM_APPEARANCE"; break;
		case 402: std::get<1>(result) = "A_RANDOM_APPEARANCE_FULL"; break;
		case 403: std::get<1>(result) = "A_RANDOM_PERSONALITY"; break;
		case 404: std::get<1>(result) = "A_CUSTOM_PERSONALITY"; break;
		case 405: std::get<1>(result) = "A_CHANGE_DREAM"; break;
		case 406: std::get<1>(result) = "A_CHANGE_GENDER"; break;
		case 407: std::get<1>(result) = "A_END_TRAVEL"; break;
		case 408: std::get<1>(result) = "A_TRAVEL_CLOUDS"; break;
		case 409: std::get<1>(result) = "A_LOG"; break;
		case 410: std::get<1>(result) = "A_TRAVEL_LOG"; break;
		case 411: std::get<1>(result) = "A_LOG_SORT"; break;
		case 412: std::get<1>(result) = "A_LOG_PIN"; break;
		case 413: std::get<1>(result) = "A_LOG_ENTITIES"; break;
		case 414: std::get<1>(result) = "A_LOG_SITES"; break;
		case 415: std::get<1>(result) = "A_LOG_SUBREGIONS"; break;
		case 416: std::get<1>(result) = "A_LOG_FEATURE_LAYERS"; break;
		case 417: std::get<1>(result) = "A_LOG_PEOPLE"; break;
		case 418: std::get<1>(result) = "A_LOG_AGREEMENTS"; break;
		case 419: std::get<1>(result) = "A_LOG_EVENTS"; break;
		case 420: std::get<1>(result) = "A_LOG_BESTIARY"; break;
		case 421: std::get<1>(result) = "A_LOG_ARTIFACTS"; break;
		case 422: std::get<1>(result) = "A_LOG_INTRIGUE"; break;
		case 423: std::get<1>(result) = "A_LOG_FILTER"; break;
		case 424: std::get<1>(result) = "A_LOG_ZOOM_CURRENT_LOCATION"; break;
		case 425: std::get<1>(result) = "A_LOG_ZOOM_SELECTED"; break;
		case 426: std::get<1>(result) = "A_LOG_LINE"; break;
		case 427: std::get<1>(result) = "A_LOG_MAP"; break;
		case 428: std::get<1>(result) = "A_BARTER_VIEW"; break;
		case 429: std::get<1>(result) = "A_BARTER_CURRENCY_1"; break;
		case 430: std::get<1>(result) = "A_BARTER_CURRENCY_2"; break;
		case 431: std::get<1>(result) = "A_BARTER_TRADE"; break;
		case 432: std::get<1>(result) = "A_BARTER_SHOW"; break;
		case 433: std::get<1>(result) = "SETUP_EMBARK"; break;
		case 434: std::get<1>(result) = "SETUP_NAME_FORT"; break;
		case 435: std::get<1>(result) = "SETUP_NAME_GROUP"; break;
		case 436: std::get<1>(result) = "SETUP_SYMBOL"; break;
		case 437: std::get<1>(result) = "SETUP_RECLAIM"; break;
		case 438: std::get<1>(result) = "SETUP_FIND"; break;
		case 439: std::get<1>(result) = "SETUP_NOTES"; break;
		case 440: std::get<1>(result) = "SETUP_NOTES_TAKE_NOTES"; break;
		case 441: std::get<1>(result) = "SETUP_NOTES_DELETE_NOTE"; break;
		case 442: std::get<1>(result) = "SETUP_NOTES_CHANGE_SYMBOL_SELECTION"; break;
		case 443: std::get<1>(result) = "SETUP_NOTES_ADOPT_SYMBOL"; break;
		case 444: std::get<1>(result) = "SETUP_LOCAL_Y_UP"; break;
		case 445: std::get<1>(result) = "SETUP_LOCAL_Y_DOWN"; break;
		case 446: std::get<1>(result) = "SETUP_LOCAL_X_UP"; break;
		case 447: std::get<1>(result) = "SETUP_LOCAL_X_DOWN"; break;
		case 448: std::get<1>(result) = "SETUP_LOCAL_Y_MUP"; break;
		case 449: std::get<1>(result) = "SETUP_LOCAL_Y_MDOWN"; break;
		case 450: std::get<1>(result) = "SETUP_LOCAL_X_MUP"; break;
		case 451: std::get<1>(result) = "SETUP_LOCAL_X_MDOWN"; break;
		case 452: std::get<1>(result) = "SETUP_BIOME_1"; break;
		case 453: std::get<1>(result) = "SETUP_BIOME_2"; break;
		case 454: std::get<1>(result) = "SETUP_BIOME_3"; break;
		case 455: std::get<1>(result) = "SETUP_BIOME_4"; break;
		case 456: std::get<1>(result) = "SETUP_BIOME_5"; break;
		case 457: std::get<1>(result) = "SETUP_BIOME_6"; break;
		case 458: std::get<1>(result) = "SETUP_BIOME_7"; break;
		case 459: std::get<1>(result) = "SETUP_BIOME_8"; break;
		case 460: std::get<1>(result) = "SETUP_BIOME_9"; break;
		case 461: std::get<1>(result) = "CHOOSE_NAME_RANDOM"; break;
		case 462: std::get<1>(result) = "CHOOSE_NAME_CLEAR"; break;
		case 463: std::get<1>(result) = "CHOOSE_NAME_TYPE"; break;
		case 464: std::get<1>(result) = "CHOOSE_NAME_FIRST"; break;
		case 465: std::get<1>(result) = "SETUPGAME_NEW"; break;
		case 466: std::get<1>(result) = "SETUPGAME_VIEW"; break;
		case 467: std::get<1>(result) = "SETUPGAME_CUSTOMIZE_UNIT"; break;
		case 468: std::get<1>(result) = "SETUPGAME_SAVE_PROFILE"; break;
		case 469: std::get<1>(result) = "SETUPGAME_SAVE_PROFILE_ABORT"; break;
		case 470: std::get<1>(result) = "SETUPGAME_SAVE_PROFILE_GO"; break;
		case 471: std::get<1>(result) = "SETUPGAME_VIEW_PROFILE_PROBLEMS"; break;
		case 472: std::get<1>(result) = "BUILDJOB_ADD"; break;
		case 473: std::get<1>(result) = "BUILDJOB_CANCEL"; break;
		case 474: std::get<1>(result) = "BUILDJOB_NAME"; break;
		case 475: std::get<1>(result) = "BUILDJOB_PROMOTE"; break;
		case 476: std::get<1>(result) = "BUILDJOB_NOW"; break;
		case 477: std::get<1>(result) = "BUILDJOB_REPEAT"; break;
		case 478: std::get<1>(result) = "BUILDJOB_SUSPEND"; break;
		case 479: std::get<1>(result) = "BUILDJOB_WORKSHOP_PROFILE"; break;
		case 480: std::get<1>(result) = "BUILDJOB_DETAILS"; break;
		case 481: std::get<1>(result) = "BUILDJOB_DETAILS_FILTER"; break;
		case 482: std::get<1>(result) = "BUILDJOB_WELL_FREE"; break;
		case 483: std::get<1>(result) = "BUILDJOB_WELL_SIZE"; break;
		case 484: std::get<1>(result) = "BUILDJOB_TARGET_FREE"; break;
		case 485: std::get<1>(result) = "BUILDJOB_TARGET_SIZE"; break;
		case 486: std::get<1>(result) = "BUILDJOB_TARGET_DOWN"; break;
		case 487: std::get<1>(result) = "BUILDJOB_TARGET_UP"; break;
		case 488: std::get<1>(result) = "BUILDJOB_TARGET_RIGHT"; break;
		case 489: std::get<1>(result) = "BUILDJOB_TARGET_LEFT"; break;
		case 490: std::get<1>(result) = "BUILDJOB_STATUE_ASSIGN"; break;
		case 491: std::get<1>(result) = "BUILDJOB_STATUE_FREE"; break;
		case 492: std::get<1>(result) = "BUILDJOB_STATUE_SIZE"; break;
		case 493: std::get<1>(result) = "BUILDJOB_CAGE_JUSTICE"; break;
		case 494: std::get<1>(result) = "BUILDJOB_CAGE_FREE"; break;
		case 495: std::get<1>(result) = "BUILDJOB_CAGE_SIZE"; break;
		case 496: std::get<1>(result) = "BUILDJOB_CAGE_ASSIGN_OCC"; break;
		case 497: std::get<1>(result) = "BUILDJOB_CAGE_WATER"; break;
		case 498: std::get<1>(result) = "BUILDJOB_CAGE_ASSIGN"; break;
		case 499: std::get<1>(result) = "BUILDJOB_CHAIN_ASSIGN_OCC"; break;
		case 500: std::get<1>(result) = "BUILDJOB_CHAIN_JUSTICE"; break;
		case 501: std::get<1>(result) = "BUILDJOB_CHAIN_ASSIGN"; break;
		case 502: std::get<1>(result) = "BUILDJOB_CHAIN_FREE"; break;
		case 503: std::get<1>(result) = "BUILDJOB_CHAIN_SIZE"; break;
		case 504: std::get<1>(result) = "BUILDJOB_SIEGE_FIRING"; break;
		case 505: std::get<1>(result) = "BUILDJOB_SIEGE_ORIENT"; break;
		case 506: std::get<1>(result) = "BUILDJOB_DOOR_INTERNAL"; break;
		case 507: std::get<1>(result) = "BUILDJOB_DOOR_LOCK"; break;
		case 508: std::get<1>(result) = "BUILDJOB_DOOR_AJAR"; break;
		case 509: std::get<1>(result) = "BUILDJOB_COFFIN_ASSIGN"; break;
		case 510: std::get<1>(result) = "BUILDJOB_COFFIN_FREE"; break;
		case 511: std::get<1>(result) = "BUILDJOB_COFFIN_SIZE"; break;
		case 512: std::get<1>(result) = "BUILDJOB_COFFIN_BURIAL"; break;
		case 513: std::get<1>(result) = "BUILDJOB_COFFIN_CIV"; break;
		case 514: std::get<1>(result) = "BUILDJOB_COFFIN_PET"; break;
		case 515: std::get<1>(result) = "BUILDJOB_CHAIR_ASSIGN"; break;
		case 516: std::get<1>(result) = "BUILDJOB_CHAIR_FREE"; break;
		case 517: std::get<1>(result) = "BUILDJOB_CHAIR_SIZE"; break;
		case 518: std::get<1>(result) = "BUILDJOB_TABLE_ASSIGN"; break;
		case 519: std::get<1>(result) = "BUILDJOB_TABLE_HALL"; break;
		case 520: std::get<1>(result) = "BUILDJOB_TABLE_FREE"; break;
		case 521: std::get<1>(result) = "BUILDJOB_TABLE_SIZE"; break;
		case 522: std::get<1>(result) = "BUILDJOB_BED_ASSIGN"; break;
		case 523: std::get<1>(result) = "BUILDJOB_BED_FREE"; break;
		case 524: std::get<1>(result) = "BUILDJOB_BED_BARRACKS"; break;
		case 525: std::get<1>(result) = "BUILDJOB_BED_DORMITORY"; break;
		case 526: std::get<1>(result) = "BUILDJOB_BED_RENT"; break;
		case 527: std::get<1>(result) = "BUILDJOB_BED_SIZE"; break;
		case 528: std::get<1>(result) = "BUILDJOB_BED_SLEEP"; break;
		case 529: std::get<1>(result) = "BUILDJOB_BED_TRAIN"; break;
		case 530: std::get<1>(result) = "BUILDJOB_BED_INDIV_EQ"; break;
		case 531: std::get<1>(result) = "BUILDJOB_BED_SQUAD_EQ"; break;
		case 532: std::get<1>(result) = "BUILDJOB_BED_POSITION"; break;
		case 533: std::get<1>(result) = "BUILDJOB_DEPOT_BRING"; break;
		case 534: std::get<1>(result) = "BUILDJOB_DEPOT_TRADE"; break;
		case 535: std::get<1>(result) = "BUILDJOB_DEPOT_REQUEST_TRADER"; break;
		case 536: std::get<1>(result) = "BUILDJOB_DEPOT_BROKER_ONLY"; break;
		case 537: std::get<1>(result) = "BUILDJOB_ANIMALTRAP_BAIT_NONE"; break;
		case 538: std::get<1>(result) = "BUILDJOB_ANIMALTRAP_BAIT_MEAT"; break;
		case 539: std::get<1>(result) = "BUILDJOB_ANIMALTRAP_BAIT_FISH"; break;
		case 540: std::get<1>(result) = "BUILDJOB_ANIMALTRAP_BAIT_GEM"; break;
		case 541: std::get<1>(result) = "BUILDJOB_FARM_FALLOW"; break;
		case 542: std::get<1>(result) = "BUILDJOB_FARM_FERTILIZE"; break;
		case 543: std::get<1>(result) = "BUILDJOB_FARM_SEASFERT"; break;
		case 544: std::get<1>(result) = "BUILDJOB_FARM_SPRING"; break;
		case 545: std::get<1>(result) = "BUILDJOB_FARM_SUMMER"; break;
		case 546: std::get<1>(result) = "BUILDJOB_FARM_AUTUMN"; break;
		case 547: std::get<1>(result) = "BUILDJOB_FARM_WINTER"; break;
		case 548: std::get<1>(result) = "BUILDJOB_RACK_MAT_BONE"; break;
		case 549: std::get<1>(result) = "BUILDJOB_RACK_MAT_BRONZE"; break;
		case 550: std::get<1>(result) = "BUILDJOB_RACK_MAT_COPPER"; break;
		case 551: std::get<1>(result) = "BUILDJOB_RACK_MAT_IRON"; break;
		case 552: std::get<1>(result) = "BUILDJOB_RACK_MAT_STEEL"; break;
		case 553: std::get<1>(result) = "BUILDJOB_RACK_MAT_WOOD"; break;
		case 554: std::get<1>(result) = "BUILDJOB_RACK_MAT_METAL"; break;
		case 555: std::get<1>(result) = "BUILDJOB_STAND_MAT_BONE"; break;
		case 556: std::get<1>(result) = "BUILDJOB_STAND_MAT_LEATHER"; break;
		case 557: std::get<1>(result) = "BUILDJOB_STAND_MAT_COPPER"; break;
		case 558: std::get<1>(result) = "BUILDJOB_STAND_MAT_BRONZE"; break;
		case 559: std::get<1>(result) = "BUILDJOB_STAND_MAT_STEEL"; break;
		case 560: std::get<1>(result) = "BUILDJOB_STAND_MAT_IRON"; break;
		case 561: std::get<1>(result) = "BUILDJOB_STAND_MAT_WOOD"; break;
		case 562: std::get<1>(result) = "BUILDJOB_STAND_MAT_METAL"; break;
		case 563: std::get<1>(result) = "BUILDJOB_RACKSTAND_ASSIGN"; break;
		case 564: std::get<1>(result) = "BUILDJOB_RACKSTAND_FREE"; break;
		case 565: std::get<1>(result) = "BUILDJOB_RACKSTAND_SIZE"; break;
		case 566: std::get<1>(result) = "BUILDJOB_RACKSTAND_ITEM"; break;
		case 567: std::get<1>(result) = "BUILDJOB_RACKSTAND_MAT"; break;
		case 568: std::get<1>(result) = "BUILDJOB_RACKSTAND_DEFAULTS1"; break;
		case 569: std::get<1>(result) = "BUILDJOB_RACKSTAND_KILL1"; break;
		case 570: std::get<1>(result) = "BUILDJOB_RACKSTAND_DEFAULTS2"; break;
		case 571: std::get<1>(result) = "BUILDJOB_RACKSTAND_KILL2"; break;
		case 572: std::get<1>(result) = "BUILDJOB_DISPLAY_FURNITURE_SET"; break;
		case 573: std::get<1>(result) = "BUILDJOB_DISPLAY_FURNITURE_CANCEL"; break;
		case 574: std::get<1>(result) = "HOTKEY_BUILDING_ARMORSTAND"; break;
		case 575: std::get<1>(result) = "HOTKEY_BUILDING_BED"; break;
		case 576: std::get<1>(result) = "HOTKEY_BUILDING_CHAIR"; break;
		case 577: std::get<1>(result) = "HOTKEY_BUILDING_COFFIN"; break;
		case 578: std::get<1>(result) = "HOTKEY_BUILDING_DOOR"; break;
		case 579: std::get<1>(result) = "HOTKEY_BUILDING_FLOODGATE"; break;
		case 580: std::get<1>(result) = "HOTKEY_BUILDING_HATCH"; break;
		case 581: std::get<1>(result) = "HOTKEY_BUILDING_GRATE_WALL"; break;
		case 582: std::get<1>(result) = "HOTKEY_BUILDING_GRATE_FLOOR"; break;
		case 583: std::get<1>(result) = "HOTKEY_BUILDING_BARS_VERTICAL"; break;
		case 584: std::get<1>(result) = "HOTKEY_BUILDING_BARS_FLOOR"; break;
		case 585: std::get<1>(result) = "HOTKEY_BUILDING_CABINET"; break;
		case 586: std::get<1>(result) = "HOTKEY_BUILDING_BOX"; break;
		case 587: std::get<1>(result) = "HOTKEY_BUILDING_KENNEL"; break;
		case 588: std::get<1>(result) = "HOTKEY_BUILDING_FARMPLOT"; break;
		case 589: std::get<1>(result) = "HOTKEY_BUILDING_WEAPONRACK"; break;
		case 590: std::get<1>(result) = "HOTKEY_BUILDING_STATUE"; break;
		case 591: std::get<1>(result) = "HOTKEY_BUILDING_TABLE"; break;
		case 592: std::get<1>(result) = "HOTKEY_BUILDING_ROAD_DIRT"; break;
		case 593: std::get<1>(result) = "HOTKEY_BUILDING_ROAD_PAVED"; break;
		case 594: std::get<1>(result) = "HOTKEY_BUILDING_BRIDGE"; break;
		case 595: std::get<1>(result) = "HOTKEY_BUILDING_WELL"; break;
		case 596: std::get<1>(result) = "HOTKEY_BUILDING_SIEGEENGINE"; break;
		case 597: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP"; break;
		case 598: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE"; break;
		case 599: std::get<1>(result) = "HOTKEY_BUILDING_WINDOW_GLASS"; break;
		case 600: std::get<1>(result) = "HOTKEY_BUILDING_WINDOW_GEM"; break;
		case 601: std::get<1>(result) = "HOTKEY_BUILDING_SHOP"; break;
		case 602: std::get<1>(result) = "HOTKEY_BUILDING_ANIMALTRAP"; break;
		case 603: std::get<1>(result) = "HOTKEY_BUILDING_CHAIN"; break;
		case 604: std::get<1>(result) = "HOTKEY_BUILDING_CAGE"; break;
		case 605: std::get<1>(result) = "HOTKEY_BUILDING_TRADEDEPOT"; break;
		case 606: std::get<1>(result) = "HOTKEY_BUILDING_TRAP"; break;
		case 607: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE"; break;
		case 608: std::get<1>(result) = "HOTKEY_BUILDING_INSTRUMENT"; break;
		case 609: std::get<1>(result) = "HOTKEY_BUILDING_SUPPORT"; break;
		case 610: std::get<1>(result) = "HOTKEY_BUILDING_ARCHERYTARGET"; break;
		case 611: std::get<1>(result) = "HOTKEY_BUILDING_TRACTION_BENCH"; break;
		case 612: std::get<1>(result) = "HOTKEY_BUILDING_SLAB"; break;
		case 613: std::get<1>(result) = "HOTKEY_BUILDING_NEST_BOX"; break;
		case 614: std::get<1>(result) = "HOTKEY_BUILDING_BOOKCASE"; break;
		case 615: std::get<1>(result) = "HOTKEY_BUILDING_HIVE"; break;
		case 616: std::get<1>(result) = "HOTKEY_BUILDING_DISPLAY_FURNITURE"; break;
		case 617: std::get<1>(result) = "HOTKEY_BUILDING_OFFERING_PLACE"; break;
		case 618: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_SCREW_PUMP"; break;
		case 619: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_WATER_WHEEL"; break;
		case 620: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_WINDMILL"; break;
		case 621: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_GEAR_ASSEMBLY"; break;
		case 622: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_AXLE_VERTICAL"; break;
		case 623: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_AXLE_HORIZONTAL"; break;
		case 624: std::get<1>(result) = "HOTKEY_BUILDING_MACHINE_ROLLERS"; break;
		case 625: std::get<1>(result) = "HOTKEY_BUILDING_SIEGEENGINE_BALLISTA"; break;
		case 626: std::get<1>(result) = "HOTKEY_BUILDING_SIEGEENGINE_CATAPULT"; break;
		case 627: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_STONE"; break;
		case 628: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_WEAPON"; break;
		case 629: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_LEVER"; break;
		case 630: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_TRIGGER"; break;
		case 631: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_CAGE"; break;
		case 632: std::get<1>(result) = "HOTKEY_BUILDING_TRAP_SPIKE"; break;
		case 633: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION"; break;
		case 634: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_WALL"; break;
		case 635: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_FLOOR"; break;
		case 636: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_RAMP"; break;
		case 637: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_STAIR_UP"; break;
		case 638: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_STAIR_DOWN"; break;
		case 639: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_STAIR_UPDOWN"; break;
		case 640: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_FORTIFICATION"; break;
		case 641: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_TRACK"; break;
		case 642: std::get<1>(result) = "HOTKEY_BUILDING_CONSTRUCTION_TRACK_STOP"; break;
		case 643: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_LEATHER"; break;
		case 644: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_QUERN"; break;
		case 645: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_MILLSTONE"; break;
		case 646: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_LOOM"; break;
		case 647: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_CLOTHES"; break;
		case 648: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_BOWYER"; break;
		case 649: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_CARPENTER"; break;
		case 650: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_METALSMITH"; break;
		case 651: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_LAVAMILL"; break;
		case 652: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_JEWELER"; break;
		case 653: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_MASON"; break;
		case 654: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_BUTCHER"; break;
		case 655: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_TANNER"; break;
		case 656: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_DYER"; break;
		case 657: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_CRAFTSMAN"; break;
		case 658: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_SIEGE"; break;
		case 659: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_MECHANIC"; break;
		case 660: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_STILL"; break;
		case 661: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_FARMER"; break;
		case 662: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_KITCHEN"; break;
		case 663: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_FISHERY"; break;
		case 664: std::get<1>(result) = "HOTKEY_BUILDING_WORKSHOP_ASHERY"; break;
		case 665: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_WOOD"; break;
		case 666: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_SMELTER"; break;
		case 667: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_GLASS"; break;
		case 668: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_KILN"; break;
		case 669: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_SMELTER_LAVA"; break;
		case 670: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_GLASS_LAVA"; break;
		case 671: std::get<1>(result) = "HOTKEY_BUILDING_FURNACE_KILN_LAVA"; break;
		case 672: std::get<1>(result) = "HIVE_INSTALL_COLONY"; break;
		case 673: std::get<1>(result) = "HIVE_GATHER_PRODUCTS"; break;
		case 674: std::get<1>(result) = "BUILDING_DIM_Y_UP"; break;
		case 675: std::get<1>(result) = "BUILDING_DIM_Y_DOWN"; break;
		case 676: std::get<1>(result) = "BUILDING_DIM_X_UP"; break;
		case 677: std::get<1>(result) = "BUILDING_DIM_X_DOWN"; break;
		case 678: std::get<1>(result) = "BUILDING_ORIENT_UP"; break;
		case 679: std::get<1>(result) = "BUILDING_ORIENT_LEFT"; break;
		case 680: std::get<1>(result) = "BUILDING_ORIENT_RIGHT"; break;
		case 681: std::get<1>(result) = "BUILDING_ORIENT_DOWN"; break;
		case 682: std::get<1>(result) = "BUILDING_ORIENT_NONE"; break;
		case 683: std::get<1>(result) = "BUILDING_VIEW_ITEM"; break;
		case 684: std::get<1>(result) = "BUILDING_ADVANCE_STAGE"; break;
		case 685: std::get<1>(result) = "BUILDING_EXPAND_CONTRACT"; break;
		case 686: std::get<1>(result) = "BUILDING_TRIGGER_ENABLE_WATER"; break;
		case 687: std::get<1>(result) = "BUILDING_TRIGGER_MIN_WATER_UP"; break;
		case 688: std::get<1>(result) = "BUILDING_TRIGGER_MIN_WATER_DOWN"; break;
		case 689: std::get<1>(result) = "BUILDING_TRIGGER_MAX_WATER_UP"; break;
		case 690: std::get<1>(result) = "BUILDING_TRIGGER_MAX_WATER_DOWN"; break;
		case 691: std::get<1>(result) = "BUILDING_TRIGGER_ENABLE_MAGMA"; break;
		case 692: std::get<1>(result) = "BUILDING_TRIGGER_MIN_MAGMA_UP"; break;
		case 693: std::get<1>(result) = "BUILDING_TRIGGER_MIN_MAGMA_DOWN"; break;
		case 694: std::get<1>(result) = "BUILDING_TRIGGER_MAX_MAGMA_UP"; break;
		case 695: std::get<1>(result) = "BUILDING_TRIGGER_MAX_MAGMA_DOWN"; break;
		case 696: std::get<1>(result) = "BUILDING_TRIGGER_ENABLE_TRACK_CART"; break;
		case 697: std::get<1>(result) = "BUILDING_TRIGGER_MIN_TRACK_CART_DOWN"; break;
		case 698: std::get<1>(result) = "BUILDING_TRIGGER_MIN_TRACK_CART_UP"; break;
		case 699: std::get<1>(result) = "BUILDING_TRIGGER_MAX_TRACK_CART_DOWN"; break;
		case 700: std::get<1>(result) = "BUILDING_TRIGGER_MAX_TRACK_CART_UP"; break;
		case 701: std::get<1>(result) = "BUILDING_TRIGGER_ENABLE_CREATURE"; break;
		case 702: std::get<1>(result) = "BUILDING_TRIGGER_ENABLE_LOCALS"; break;
		case 703: std::get<1>(result) = "BUILDING_TRIGGER_RESETS"; break;
		case 704: std::get<1>(result) = "BUILDING_TRIGGER_MIN_SIZE_UP"; break;
		case 705: std::get<1>(result) = "BUILDING_TRIGGER_MIN_SIZE_DOWN"; break;
		case 706: std::get<1>(result) = "BUILDING_TRIGGER_MAX_SIZE_UP"; break;
		case 707: std::get<1>(result) = "BUILDING_TRIGGER_MAX_SIZE_DOWN"; break;
		case 708: std::get<1>(result) = "BUILDING_TRIGGER_MIN_SIZE_UP_PLUS"; break;
		case 709: std::get<1>(result) = "BUILDING_TRIGGER_MIN_SIZE_DOWN_PLUS"; break;
		case 710: std::get<1>(result) = "BUILDING_TRIGGER_MAX_SIZE_UP_PLUS"; break;
		case 711: std::get<1>(result) = "BUILDING_TRIGGER_MAX_SIZE_DOWN_PLUS"; break;
		case 712: std::get<1>(result) = "BUILDING_ROLLERS_SPEED_UP"; break;
		case 713: std::get<1>(result) = "BUILDING_ROLLERS_SPEED_DOWN"; break;
		case 714: std::get<1>(result) = "BUILDING_TRACK_STOP_FRICTION_UP"; break;
		case 715: std::get<1>(result) = "BUILDING_TRACK_STOP_FRICTION_DOWN"; break;
		case 716: std::get<1>(result) = "BUILDING_TRACK_STOP_DUMP"; break;
		case 717: std::get<1>(result) = "DESTROYBUILDING"; break;
		case 718: std::get<1>(result) = "SUSPENDBUILDING"; break;
		case 719: std::get<1>(result) = "BUILDINGLIST_ZOOM_T"; break;
		case 720: std::get<1>(result) = "BUILDINGLIST_ZOOM_Q"; break;
		case 721: std::get<1>(result) = "RECENTER_ON_LEVER"; break;
		case 722: std::get<1>(result) = "ASSIGN_LOCATION"; break;
		case 723: std::get<1>(result) = "LOCATION_NEW"; break;
		case 724: std::get<1>(result) = "LOCATION_RETIRE"; break;
		case 725: std::get<1>(result) = "LOCATION_INN_TAVERN"; break;
		case 726: std::get<1>(result) = "LOCATION_TEMPLE"; break;
		case 727: std::get<1>(result) = "LOCATION_RECOGNIZE_PRIESTHOOD"; break;
		case 728: std::get<1>(result) = "LOCATION_LIBRARY"; break;
		case 729: std::get<1>(result) = "LOCATION_GUILDHALL"; break;
		case 730: std::get<1>(result) = "LOCATION_MAIN_HALL"; break;
		case 731: std::get<1>(result) = "LOCATION_RENAME"; break;
		case 732: std::get<1>(result) = "LOCATION_DETAILS"; break;
		case 733: std::get<1>(result) = "LOCATION_RESTRICTION"; break;
		case 734: std::get<1>(result) = "LOCATION_SET_NUMBER_1"; break;
		case 735: std::get<1>(result) = "LOCATION_SET_NUMBER_2"; break;
		case 736: std::get<1>(result) = "HOTKEY_MAKE_ASH"; break;
		case 737: std::get<1>(result) = "HOTKEY_MAKE_CHARCOAL"; break;
		case 738: std::get<1>(result) = "HOTKEY_MELT_OBJECT"; break;
		case 739: std::get<1>(result) = "HOTKEY_GLASS_GREEN"; break;
		case 740: std::get<1>(result) = "HOTKEY_GLASS_CLEAR"; break;
		case 741: std::get<1>(result) = "HOTKEY_GLASS_CRYSTAL"; break;
		case 742: std::get<1>(result) = "HOTKEY_COLLECT_SAND"; break;
		case 743: std::get<1>(result) = "HOTKEY_COLLECT_CLAY"; break;
		case 744: std::get<1>(result) = "HOTKEY_GLASS_ROUGH"; break;
		case 745: std::get<1>(result) = "HOTKEY_GLASS_ARMORSTAND"; break;
		case 746: std::get<1>(result) = "HOTKEY_GLASS_BOX"; break;
		case 747: std::get<1>(result) = "HOTKEY_GLASS_CABINET"; break;
		case 748: std::get<1>(result) = "HOTKEY_GLASS_COFFIN"; break;
		case 749: std::get<1>(result) = "HOTKEY_GLASS_FLOODGATE"; break;
		case 750: std::get<1>(result) = "HOTKEY_GLASS_HATCH_COVER"; break;
		case 751: std::get<1>(result) = "HOTKEY_GLASS_GRATE"; break;
		case 752: std::get<1>(result) = "HOTKEY_GLASS_GOBLET"; break;
		case 753: std::get<1>(result) = "HOTKEY_GLASS_TOY"; break;
		case 754: std::get<1>(result) = "HOTKEY_GLASS_DOOR"; break;
		case 755: std::get<1>(result) = "HOTKEY_GLASS_STATUE"; break;
		case 756: std::get<1>(result) = "HOTKEY_GLASS_TABLE"; break;
		case 757: std::get<1>(result) = "HOTKEY_GLASS_CAGE"; break;
		case 758: std::get<1>(result) = "HOTKEY_GLASS_CHAIR"; break;
		case 759: std::get<1>(result) = "HOTKEY_GLASS_BLOCKS"; break;
		case 760: std::get<1>(result) = "HOTKEY_GLASS_FLASK"; break;
		case 761: std::get<1>(result) = "HOTKEY_GLASS_WEAPONRACK"; break;
		case 762: std::get<1>(result) = "HOTKEY_GLASS_WINDOW"; break;
		case 763: std::get<1>(result) = "HOTKEY_ASHERY_LYE"; break;
		case 764: std::get<1>(result) = "HOTKEY_ASHERY_POTASH"; break;
		case 765: std::get<1>(result) = "HOTKEY_ASHERY_POTASH_DIRECT"; break;
		case 766: std::get<1>(result) = "HOTKEY_CARPENTER_BARREL"; break;
		case 767: std::get<1>(result) = "HOTKEY_CARPENTER_BLOCKS"; break;
		case 768: std::get<1>(result) = "HOTKEY_CARPENTER_BUCKET"; break;
		case 769: std::get<1>(result) = "HOTKEY_CARPENTER_TRAP_ANIMAL"; break;
		case 770: std::get<1>(result) = "HOTKEY_CARPENTER_CAGE"; break;
		case 771: std::get<1>(result) = "HOTKEY_CARPENTER_ARMORSTAND"; break;
		case 772: std::get<1>(result) = "HOTKEY_CARPENTER_BED"; break;
		case 773: std::get<1>(result) = "HOTKEY_CARPENTER_CHAIR"; break;
		case 774: std::get<1>(result) = "HOTKEY_CARPENTER_COFFIN"; break;
		case 775: std::get<1>(result) = "HOTKEY_CARPENTER_DOOR"; break;
		case 776: std::get<1>(result) = "HOTKEY_CARPENTER_FLOODGATE"; break;
		case 777: std::get<1>(result) = "HOTKEY_CARPENTER_HATCH_COVER"; break;
		case 778: std::get<1>(result) = "HOTKEY_CARPENTER_GRATE"; break;
		case 779: std::get<1>(result) = "HOTKEY_CARPENTER_CABINET"; break;
		case 780: std::get<1>(result) = "HOTKEY_CARPENTER_BIN"; break;
		case 781: std::get<1>(result) = "HOTKEY_CARPENTER_BOX"; break;
		case 782: std::get<1>(result) = "HOTKEY_CARPENTER_WEAPONRACK"; break;
		case 783: std::get<1>(result) = "HOTKEY_CARPENTER_TABLE"; break;
		case 784: std::get<1>(result) = "HOTKEY_SIEGE_BALLISTA"; break;
		case 785: std::get<1>(result) = "HOTKEY_SIEGE_CATAPULT"; break;
		case 786: std::get<1>(result) = "HOTKEY_LEATHER_BOX"; break;
		case 787: std::get<1>(result) = "HOTKEY_LEATHER_FLASK"; break;
		case 788: std::get<1>(result) = "HOTKEY_LEATHER_SHIRT"; break;
		case 789: std::get<1>(result) = "HOTKEY_LEATHER_CLOAK"; break;
		case 790: std::get<1>(result) = "HOTKEY_LEATHER_BACKPACK"; break;
		case 791: std::get<1>(result) = "HOTKEY_LEATHER_QUIVER"; break;
		case 792: std::get<1>(result) = "HOTKEY_LEATHER_IMAGE"; break;
		case 793: std::get<1>(result) = "HOTKEY_CLOTHES_MAT_PLANT"; break;
		case 794: std::get<1>(result) = "HOTKEY_CLOTHES_MAT_SILK"; break;
		case 795: std::get<1>(result) = "HOTKEY_CLOTHES_MAT_YARN"; break;
		case 796: std::get<1>(result) = "HOTKEY_CLOTHES_SHIRT"; break;
		case 797: std::get<1>(result) = "HOTKEY_CLOTHES_CLOAK"; break;
		case 798: std::get<1>(result) = "HOTKEY_CLOTHES_BOX"; break;
		case 799: std::get<1>(result) = "HOTKEY_CLOTHES_CHAIN"; break;
		case 800: std::get<1>(result) = "HOTKEY_CLOTHES_IMAGE"; break;
		case 801: std::get<1>(result) = "HOTKEY_CRAFTS_MAT_STONE"; break;
		case 802: std::get<1>(result) = "HOTKEY_CRAFTS_MAT_WOOD"; break;
		case 803: std::get<1>(result) = "HOTKEY_CRAFTS_DEC_BONE"; break;
		case 804: std::get<1>(result) = "HOTKEY_CRAFTS_DEC_SHELL"; break;
		case 805: std::get<1>(result) = "HOTKEY_CRAFTS_DEC_TOOTH"; break;
		case 806: std::get<1>(result) = "HOTKEY_CRAFTS_DEC_HORN"; break;
		case 807: std::get<1>(result) = "HOTKEY_CRAFTS_DEC_PEARL"; break;
		case 808: std::get<1>(result) = "HOTKEY_CRAFTS_TOTEM"; break;
		case 809: std::get<1>(result) = "HOTKEY_CRAFTS_CLOTH"; break;
		case 810: std::get<1>(result) = "HOTKEY_CRAFTS_SILK"; break;
		case 811: std::get<1>(result) = "HOTKEY_CRAFTS_YARN"; break;
		case 812: std::get<1>(result) = "HOTKEY_CRAFTS_SEL_WOOD"; break;
		case 813: std::get<1>(result) = "HOTKEY_CRAFTS_SEL_BONE"; break;
		case 814: std::get<1>(result) = "HOTKEY_CRAFTS_SEL_SHELL"; break;
		case 815: std::get<1>(result) = "HOTKEY_CRAFTS_SHELL"; break;
		case 816: std::get<1>(result) = "HOTKEY_CRAFTS_TOOTH"; break;
		case 817: std::get<1>(result) = "HOTKEY_CRAFTS_HORN"; break;
		case 818: std::get<1>(result) = "HOTKEY_CRAFTS_PEARL"; break;
		case 819: std::get<1>(result) = "HOTKEY_CRAFTS_BONE"; break;
		case 820: std::get<1>(result) = "HOTKEY_CRAFTS_LEATHER"; break;
		case 821: std::get<1>(result) = "HOTKEY_CRAFTS_SLAB"; break;
		case 822: std::get<1>(result) = "HOTKEY_CRAFTS_MAT_CRAFTS"; break;
		case 823: std::get<1>(result) = "HOTKEY_CRAFTS_MAT_GOBLET"; break;
		case 824: std::get<1>(result) = "HOTKEY_CRAFTS_MAT_TOY"; break;
		case 825: std::get<1>(result) = "HOTKEY_SMITH_WEAPON"; break;
		case 826: std::get<1>(result) = "HOTKEY_SMITH_ARMOR"; break;
		case 827: std::get<1>(result) = "HOTKEY_SMITH_FURNITURE"; break;
		case 828: std::get<1>(result) = "HOTKEY_SMITH_SIEGE"; break;
		case 829: std::get<1>(result) = "HOTKEY_SMITH_TRAP"; break;
		case 830: std::get<1>(result) = "HOTKEY_SMITH_OTHER"; break;
		case 831: std::get<1>(result) = "HOTKEY_SMITH_METAL"; break;
		case 832: std::get<1>(result) = "HOTKEY_ALCHEMIST_SOAP"; break;
		case 833: std::get<1>(result) = "HOTKEY_STILL_BREW"; break;
		case 834: std::get<1>(result) = "HOTKEY_STILL_EXTRACT"; break;
		case 835: std::get<1>(result) = "HOTKEY_LOOM_COLLECT_SILK"; break;
		case 836: std::get<1>(result) = "HOTKEY_LOOM_WEAVE_CLOTH"; break;
		case 837: std::get<1>(result) = "HOTKEY_LOOM_WEAVE_SILK"; break;
		case 838: std::get<1>(result) = "HOTKEY_LOOM_WEAVE_YARN"; break;
		case 839: std::get<1>(result) = "HOTKEY_LOOM_WEAVE_METAL"; break;
		case 840: std::get<1>(result) = "HOTKEY_KITCHEN_COOK_2"; break;
		case 841: std::get<1>(result) = "HOTKEY_KITCHEN_COOK_3"; break;
		case 842: std::get<1>(result) = "HOTKEY_KITCHEN_COOK_4"; break;
		case 843: std::get<1>(result) = "HOTKEY_KITCHEN_RENDER_FAT"; break;
		case 844: std::get<1>(result) = "HOTKEY_FARMER_PROCESS"; break;
		case 845: std::get<1>(result) = "HOTKEY_FARMER_PROCESS_VIAL"; break;
		case 846: std::get<1>(result) = "HOTKEY_FARMER_PROCESS_BAG"; break;
		case 847: std::get<1>(result) = "HOTKEY_FARMER_PROCESS_BARREL"; break;
		case 848: std::get<1>(result) = "HOTKEY_FARMER_CHEESE"; break;
		case 849: std::get<1>(result) = "HOTKEY_FARMER_MILK"; break;
		case 850: std::get<1>(result) = "HOTKEY_FARMER_SHEAR_CREATURE"; break;
		case 851: std::get<1>(result) = "HOTKEY_FARMER_SPIN_THREAD"; break;
		case 852: std::get<1>(result) = "HOTKEY_MILL_MILL"; break;
		case 853: std::get<1>(result) = "HOTKEY_KENNEL_CATCH_VERMIN"; break;
		case 854: std::get<1>(result) = "HOTKEY_KENNEL_TAME_VERMIN"; break;
		case 855: std::get<1>(result) = "HOTKEY_FISHERY_PROCESS"; break;
		case 856: std::get<1>(result) = "HOTKEY_FISHERY_EXTRACT"; break;
		case 857: std::get<1>(result) = "HOTKEY_FISHERY_CATCH"; break;
		case 858: std::get<1>(result) = "HOTKEY_BUTCHER_BUTCHER"; break;
		case 859: std::get<1>(result) = "HOTKEY_BUTCHER_EXTRACT"; break;
		case 860: std::get<1>(result) = "HOTKEY_BUTCHER_CATCH"; break;
		case 861: std::get<1>(result) = "HOTKEY_TANNER_TAN"; break;
		case 862: std::get<1>(result) = "HOTKEY_DYER_THREAD"; break;
		case 863: std::get<1>(result) = "HOTKEY_DYER_CLOTH"; break;
		case 864: std::get<1>(result) = "HOTKEY_JEWELER_FURNITURE"; break;
		case 865: std::get<1>(result) = "HOTKEY_JEWELER_FINISHED"; break;
		case 866: std::get<1>(result) = "HOTKEY_JEWELER_AMMO"; break;
		case 867: std::get<1>(result) = "HOTKEY_JEWELER_CUT"; break;
		case 868: std::get<1>(result) = "HOTKEY_JEWELER_ENCRUST"; break;
		case 869: std::get<1>(result) = "HOTKEY_MECHANIC_PARTS"; break;
		case 870: std::get<1>(result) = "HOTKEY_MECHANIC_TRACTION_BENCH"; break;
		case 871: std::get<1>(result) = "HOTKEY_MASON_ARMORSTAND"; break;
		case 872: std::get<1>(result) = "HOTKEY_MASON_BLOCKS"; break;
		case 873: std::get<1>(result) = "HOTKEY_MASON_CHAIR"; break;
		case 874: std::get<1>(result) = "HOTKEY_MASON_COFFIN"; break;
		case 875: std::get<1>(result) = "HOTKEY_MASON_DOOR"; break;
		case 876: std::get<1>(result) = "HOTKEY_MASON_FLOODGATE"; break;
		case 877: std::get<1>(result) = "HOTKEY_MASON_HATCH_COVER"; break;
		case 878: std::get<1>(result) = "HOTKEY_MASON_GRATE"; break;
		case 879: std::get<1>(result) = "HOTKEY_MASON_CABINET"; break;
		case 880: std::get<1>(result) = "HOTKEY_MASON_BOX"; break;
		case 881: std::get<1>(result) = "HOTKEY_MASON_STATUE"; break;
		case 882: std::get<1>(result) = "HOTKEY_MASON_TABLE"; break;
		case 883: std::get<1>(result) = "HOTKEY_MASON_WEAPONRACK"; break;
		case 884: std::get<1>(result) = "HOTKEY_MASON_QUERN"; break;
		case 885: std::get<1>(result) = "HOTKEY_MASON_MILLSTONE"; break;
		case 886: std::get<1>(result) = "HOTKEY_MASON_SLAB"; break;
		case 887: std::get<1>(result) = "HOTKEY_TRAP_BRIDGE"; break;
		case 888: std::get<1>(result) = "HOTKEY_TRAP_DOOR"; break;
		case 889: std::get<1>(result) = "HOTKEY_TRAP_FLOODGATE"; break;
		case 890: std::get<1>(result) = "HOTKEY_TRAP_SPIKE"; break;
		case 891: std::get<1>(result) = "HOTKEY_TRAP_HATCH"; break;
		case 892: std::get<1>(result) = "HOTKEY_TRAP_GRATE_WALL"; break;
		case 893: std::get<1>(result) = "HOTKEY_TRAP_GRATE_FLOOR"; break;
		case 894: std::get<1>(result) = "HOTKEY_TRAP_BARS_VERTICAL"; break;
		case 895: std::get<1>(result) = "HOTKEY_TRAP_BARS_FLOOR"; break;
		case 896: std::get<1>(result) = "HOTKEY_TRAP_SUPPORT"; break;
		case 897: std::get<1>(result) = "HOTKEY_TRAP_CHAIN"; break;
		case 898: std::get<1>(result) = "HOTKEY_TRAP_CAGE"; break;
		case 899: std::get<1>(result) = "HOTKEY_TRAP_GEAR_ASSEMBLY"; break;
		case 900: std::get<1>(result) = "HOTKEY_TRAP_TRACK_STOP"; break;
		case 901: std::get<1>(result) = "HOTKEY_TRAP_PULL_LEVER"; break;
		case 902: std::get<1>(result) = "BUILDJOB_STOCKPILE_MASTER"; break;
		case 903: std::get<1>(result) = "BUILDJOB_STOCKPILE_LINK_ANYWHERE"; break;
		case 904: std::get<1>(result) = "BUILDJOB_STOCKPILE_GIVE_TO"; break;
		case 905: std::get<1>(result) = "BUILDJOB_STOCKPILE_DELETE_CHILD"; break;
		case 906: std::get<1>(result) = "BUILDJOB_STOCKPILE_SETTINGS"; break;
		case 907: std::get<1>(result) = "BUILDJOB_STOCKPILE_BARREL_UP"; break;
		case 908: std::get<1>(result) = "BUILDJOB_STOCKPILE_BARREL_DOWN"; break;
		case 909: std::get<1>(result) = "BUILDJOB_STOCKPILE_BARREL_ZERO"; break;
		case 910: std::get<1>(result) = "BUILDJOB_STOCKPILE_BARREL_MAX"; break;
		case 911: std::get<1>(result) = "BUILDJOB_STOCKPILE_BIN_UP"; break;
		case 912: std::get<1>(result) = "BUILDJOB_STOCKPILE_BIN_DOWN"; break;
		case 913: std::get<1>(result) = "BUILDJOB_STOCKPILE_BIN_ZERO"; break;
		case 914: std::get<1>(result) = "BUILDJOB_STOCKPILE_BIN_MAX"; break;
		case 915: std::get<1>(result) = "BUILDJOB_STOCKPILE_WHEELBARROW"; break;
		case 916: std::get<1>(result) = "STOCKPILE_ANIMAL"; break;
		case 917: std::get<1>(result) = "STOCKPILE_FOOD"; break;
		case 918: std::get<1>(result) = "STOCKPILE_WEAPON"; break;
		case 919: std::get<1>(result) = "STOCKPILE_ARMOR"; break;
		case 920: std::get<1>(result) = "STOCKPILE_CUSTOM"; break;
		case 921: std::get<1>(result) = "STOCKPILE_CUSTOM_SETTINGS"; break;
		case 922: std::get<1>(result) = "STOCKPILE_FURNITURE"; break;
		case 923: std::get<1>(result) = "STOCKPILE_GRAVEYARD"; break;
		case 924: std::get<1>(result) = "STOCKPILE_REFUSE"; break;
		case 925: std::get<1>(result) = "STOCKPILE_WOOD"; break;
		case 926: std::get<1>(result) = "STOCKPILE_STONE"; break;
		case 927: std::get<1>(result) = "STOCKPILE_GEM"; break;
		case 928: std::get<1>(result) = "STOCKPILE_BARBLOCK"; break;
		case 929: std::get<1>(result) = "STOCKPILE_CLOTH"; break;
		case 930: std::get<1>(result) = "STOCKPILE_LEATHER"; break;
		case 931: std::get<1>(result) = "STOCKPILE_AMMO"; break;
		case 932: std::get<1>(result) = "STOCKPILE_COINS"; break;
		case 933: std::get<1>(result) = "STOCKPILE_FINISHED"; break;
		case 934: std::get<1>(result) = "STOCKPILE_SHEET"; break;
		case 935: std::get<1>(result) = "STOCKPILE_NONE"; break;
		case 936: std::get<1>(result) = "STOCKPILE_SETTINGS_ENABLE"; break;
		case 937: std::get<1>(result) = "STOCKPILE_SETTINGS_DISABLE"; break;
		case 938: std::get<1>(result) = "STOCKPILE_SETTINGS_PERMIT_ALL"; break;
		case 939: std::get<1>(result) = "STOCKPILE_SETTINGS_FORBID_ALL"; break;
		case 940: std::get<1>(result) = "STOCKPILE_SETTINGS_PERMIT_SUB"; break;
		case 941: std::get<1>(result) = "STOCKPILE_SETTINGS_FORBID_SUB"; break;
		case 942: std::get<1>(result) = "STOCKPILE_SETTINGS_SPECIFIC1"; break;
		case 943: std::get<1>(result) = "STOCKPILE_SETTINGS_SPECIFIC2"; break;
		case 944: std::get<1>(result) = "CIVZONE_NAME"; break;
		case 945: std::get<1>(result) = "CIVZONE_REMOVE"; break;
		case 946: std::get<1>(result) = "CIVZONE_REMOVE_ZONE"; break;
		case 947: std::get<1>(result) = "CIVZONE_SHAPE"; break;
		case 948: std::get<1>(result) = "CIVZONE_NEXT"; break;
		case 949: std::get<1>(result) = "CIVZONE_WATER_SOURCE"; break;
		case 950: std::get<1>(result) = "CIVZONE_FISH"; break;
		case 951: std::get<1>(result) = "CIVZONE_GATHER"; break;
		case 952: std::get<1>(result) = "CIVZONE_DUMP"; break;
		case 953: std::get<1>(result) = "CIVZONE_POND"; break;
		case 954: std::get<1>(result) = "CIVZONE_HOSPITAL"; break;
		case 955: std::get<1>(result) = "CIVZONE_SAND_COLLECT"; break;
		case 956: std::get<1>(result) = "CIVZONE_CLAY_COLLECT"; break;
		case 957: std::get<1>(result) = "CIVZONE_ACTIVE"; break;
		case 958: std::get<1>(result) = "CIVZONE_MEETING"; break;
		case 959: std::get<1>(result) = "CIVZONE_ANIMAL_TRAINING"; break;
		case 960: std::get<1>(result) = "CIVZONE_PEN"; break;
		case 961: std::get<1>(result) = "CIVZONE_PEN_OPTIONS"; break;
		case 962: std::get<1>(result) = "CIVZONE_POND_OPTIONS"; break;
		case 963: std::get<1>(result) = "CIVZONE_POND_WATER"; break;
		case 964: std::get<1>(result) = "CIVZONE_HOSPITAL_OPTIONS"; break;
		case 965: std::get<1>(result) = "CIVZONE_GATHER_OPTIONS"; break;
		case 966: std::get<1>(result) = "CIVZONE_GATHER_OPTIONS_PICK_TREES"; break;
		case 967: std::get<1>(result) = "CIVZONE_GATHER_OPTIONS_PICK_SHRUBS"; break;
		case 968: std::get<1>(result) = "CIVZONE_GATHER_OPTIONS_GATHER_FALLEN"; break;
		case 969: std::get<1>(result) = "STORES_VIEW"; break;
		case 970: std::get<1>(result) = "STORES_ZOOM"; break;
		case 971: std::get<1>(result) = "STORES_FORBID"; break;
		case 972: std::get<1>(result) = "STORES_MELT"; break;
		case 973: std::get<1>(result) = "STORES_DUMP"; break;
		case 974: std::get<1>(result) = "STORES_HIDE"; break;
		case 975: std::get<1>(result) = "PET_BUTCHER"; break;
		case 976: std::get<1>(result) = "PET_GELD"; break;
		case 977: std::get<1>(result) = "ANIMAL_SELECT_TRAINER"; break;
		case 978: std::get<1>(result) = "ANIMAL_WAR_TRAINING"; break;
		case 979: std::get<1>(result) = "ANIMAL_HUNTING_TRAINING"; break;
		case 980: std::get<1>(result) = "KITCHEN_COOK"; break;
		case 981: std::get<1>(result) = "KITCHEN_BREW"; break;
		case 982: std::get<1>(result) = "JUSTICE_INTERROGATE"; break;
		case 983: std::get<1>(result) = "JUSTICE_COUNTERINTELLIGENCE"; break;
		case 984: std::get<1>(result) = "ORDERS_AUTOFORBID"; break;
		case 985: std::get<1>(result) = "ORDERS_FORBID_PROJECTILE"; break;
		case 986: std::get<1>(result) = "ORDERS_FORBID_YOUR_CORPSE"; break;
		case 987: std::get<1>(result) = "ORDERS_FORBID_YOUR_ITEMS"; break;
		case 988: std::get<1>(result) = "ORDERS_FORBID_OTHER_CORPSE"; break;
		case 989: std::get<1>(result) = "ORDERS_FORBID_OTHER_ITEMS"; break;
		case 990: std::get<1>(result) = "ORDERS_REFUSE_GATHER"; break;
		case 991: std::get<1>(result) = "ORDERS_REFUSE_OUTSIDE"; break;
		case 992: std::get<1>(result) = "ORDERS_REFUSE_OUTSIDE_VERMIN"; break;
		case 993: std::get<1>(result) = "ORDERS_REFUSE_DUMP_CORPSE"; break;
		case 994: std::get<1>(result) = "ORDERS_REFUSE_DUMP_SKULL"; break;
		case 995: std::get<1>(result) = "ORDERS_REFUSE_DUMP_BONE"; break;
		case 996: std::get<1>(result) = "ORDERS_REFUSE_DUMP_SHELL"; break;
		case 997: std::get<1>(result) = "ORDERS_REFUSE_DUMP_SKIN"; break;
		case 998: std::get<1>(result) = "ORDERS_REFUSE_DUMP_OTHER"; break;
		case 999: std::get<1>(result) = "ORDERS_REFUSE_DUMP_STRAND_TISSUE"; break;
		case 1000: std::get<1>(result) = "ORDERS_GATHER_FURNITURE"; break;
		case 1001: std::get<1>(result) = "ORDERS_GATHER_ANIMALS"; break;
		case 1002: std::get<1>(result) = "ORDERS_GATHER_FOOD"; break;
		case 1003: std::get<1>(result) = "ORDERS_GATHER_BODIES"; break;
		case 1004: std::get<1>(result) = "ORDERS_REFUSE"; break;
		case 1005: std::get<1>(result) = "ORDERS_GATHER_STONE"; break;
		case 1006: std::get<1>(result) = "ORDERS_GATHER_WOOD"; break;
		case 1007: std::get<1>(result) = "ORDERS_ALL_HARVEST"; break;
		case 1008: std::get<1>(result) = "ORDERS_SAMEPILE"; break;
		case 1009: std::get<1>(result) = "ORDERS_MIXFOODS"; break;
		case 1010: std::get<1>(result) = "ORDERS_LOOM"; break;
		case 1011: std::get<1>(result) = "ORDERS_DYED_CLOTH"; break;
		case 1012: std::get<1>(result) = "ORDERS_EXCEPTIONS"; break;
		case 1013: std::get<1>(result) = "ORDERS_WORKSHOP"; break;
		case 1014: std::get<1>(result) = "ORDERS_COLLECT_WEB"; break;
		case 1015: std::get<1>(result) = "ORDERS_SLAUGHTER"; break;
		case 1016: std::get<1>(result) = "ORDERS_BUTCHER"; break;
		case 1017: std::get<1>(result) = "ORDERS_TAN"; break;
		case 1018: std::get<1>(result) = "ORDERS_AUTO_FISHERY"; break;
		case 1019: std::get<1>(result) = "ORDERS_AUTO_KITCHEN"; break;
		case 1020: std::get<1>(result) = "ORDERS_AUTO_KILN"; break;
		case 1021: std::get<1>(result) = "ORDERS_AUTO_SMELTER"; break;
		case 1022: std::get<1>(result) = "ORDERS_AUTO_OTHER"; break;
		case 1023: std::get<1>(result) = "ORDERS_ZONE"; break;
		case 1024: std::get<1>(result) = "ORDERS_ZONE_DRINKING"; break;
		case 1025: std::get<1>(result) = "ORDERS_ZONE_FISHING"; break;
		case 1026: std::get<1>(result) = "D_ONESTEP"; break;
		case 1027: std::get<1>(result) = "D_PAUSE"; break;
		case 1028: std::get<1>(result) = "D_DEPOT"; break;
		case 1029: std::get<1>(result) = "D_HOT_KEYS"; break;
		case 1030: std::get<1>(result) = "D_HOTKEY1"; break;
		case 1031: std::get<1>(result) = "D_HOTKEY2"; break;
		case 1032: std::get<1>(result) = "D_HOTKEY3"; break;
		case 1033: std::get<1>(result) = "D_HOTKEY4"; break;
		case 1034: std::get<1>(result) = "D_HOTKEY5"; break;
		case 1035: std::get<1>(result) = "D_HOTKEY6"; break;
		case 1036: std::get<1>(result) = "D_HOTKEY7"; break;
		case 1037: std::get<1>(result) = "D_HOTKEY8"; break;
		case 1038: std::get<1>(result) = "D_HOTKEY9"; break;
		case 1039: std::get<1>(result) = "D_HOTKEY10"; break;
		case 1040: std::get<1>(result) = "D_HOTKEY11"; break;
		case 1041: std::get<1>(result) = "D_HOTKEY12"; break;
		case 1042: std::get<1>(result) = "D_HOTKEY13"; break;
		case 1043: std::get<1>(result) = "D_HOTKEY14"; break;
		case 1044: std::get<1>(result) = "D_HOTKEY15"; break;
		case 1045: std::get<1>(result) = "D_HOTKEY16"; break;
		case 1046: std::get<1>(result) = "D_HOTKEY_CHANGE_NAME"; break;
		case 1047: std::get<1>(result) = "D_HOTKEY_ZOOM"; break;
		case 1048: std::get<1>(result) = "D_ANNOUNCE"; break;
		case 1049: std::get<1>(result) = "D_REPORTS"; break;
		case 1050: std::get<1>(result) = "D_BUILDING"; break;
		case 1051: std::get<1>(result) = "D_CIVLIST"; break;
		case 1052: std::get<1>(result) = "D_DESIGNATE"; break;
		case 1053: std::get<1>(result) = "D_ARTLIST"; break;
		case 1054: std::get<1>(result) = "D_NOBLES"; break;
		case 1055: std::get<1>(result) = "D_ORDERS"; break;
		case 1056: std::get<1>(result) = "D_PETITIONS"; break;
		case 1057: std::get<1>(result) = "D_LOCATIONS"; break;
		case 1058: std::get<1>(result) = "D_MILITARY"; break;
		case 1059: std::get<1>(result) = "D_ROOMS"; break;
		case 1060: std::get<1>(result) = "D_SQUADS"; break;
		case 1061: std::get<1>(result) = "D_STOCKPILES"; break;
		case 1062: std::get<1>(result) = "D_CIVZONE"; break;
		case 1063: std::get<1>(result) = "D_VIEWUNIT"; break;
		case 1064: std::get<1>(result) = "D_JOBLIST"; break;
		case 1065: std::get<1>(result) = "D_UNITLIST"; break;
		case 1066: std::get<1>(result) = "D_LOOK"; break;
		case 1067: std::get<1>(result) = "D_HAULING"; break;
		case 1068: std::get<1>(result) = "D_HAULING_NEW_ROUTE"; break;
		case 1069: std::get<1>(result) = "D_HAULING_NEW_STOP"; break;
		case 1070: std::get<1>(result) = "D_HAULING_REMOVE"; break;
		case 1071: std::get<1>(result) = "D_HAULING_PROMOTE"; break;
		case 1072: std::get<1>(result) = "D_HAULING_VEHICLE"; break;
		case 1073: std::get<1>(result) = "D_HAULING_NICKNAME"; break;
		case 1074: std::get<1>(result) = "D_HAULING_STOP_NEW_DEPART"; break;
		case 1075: std::get<1>(result) = "D_HAULING_STOP_NEW_LINK"; break;
		case 1076: std::get<1>(result) = "D_HAULING_STOP_REMOVE"; break;
		case 1077: std::get<1>(result) = "D_HAULING_STOP_SL_SELECT_PILE"; break;
		case 1078: std::get<1>(result) = "D_HAULING_STOP_SL_TAKE_GIVE"; break;
		case 1079: std::get<1>(result) = "D_HAULING_STOP_LC_DIR"; break;
		case 1080: std::get<1>(result) = "D_HAULING_STOP_LC_MODE"; break;
		case 1081: std::get<1>(result) = "D_HAULING_STOP_LC_TIMER_UP"; break;
		case 1082: std::get<1>(result) = "D_HAULING_STOP_LC_TIMER_DOWN"; break;
		case 1083: std::get<1>(result) = "D_HAULING_STOP_LC_FULLNESS_UP"; break;
		case 1084: std::get<1>(result) = "D_HAULING_STOP_LC_FULLNESS_DOWN"; break;
		case 1085: std::get<1>(result) = "D_HAULING_STOP_LC_MORE_LESS"; break;
		case 1086: std::get<1>(result) = "D_HAULING_STOP_LC_DESIRED_TOTAL"; break;
		case 1087: std::get<1>(result) = "D_HAULING_STOP_LC_CHANGE"; break;
		case 1088: std::get<1>(result) = "D_HAULING_STOP_LC_ADVANCED"; break;
		case 1089: std::get<1>(result) = "D_BURROWS"; break;
		case 1090: std::get<1>(result) = "D_BURROWS_ADD"; break;
		case 1091: std::get<1>(result) = "D_BURROWS_DELETE"; break;
		case 1092: std::get<1>(result) = "D_BURROWS_DEFINE"; break;
		case 1093: std::get<1>(result) = "D_BURROWS_ADD_UNIT"; break;
		case 1094: std::get<1>(result) = "D_BURROWS_WORKSHOP_LIMIT"; break;
		case 1095: std::get<1>(result) = "D_BURROWS_CENTER"; break;
		case 1096: std::get<1>(result) = "D_BURROWS_NAME"; break;
		case 1097: std::get<1>(result) = "D_BURROWS_CHANGE_SELECTION"; break;
		case 1098: std::get<1>(result) = "D_BURROWS_BRUSH"; break;
		case 1099: std::get<1>(result) = "D_BURROWS_REMOVE"; break;
		case 1100: std::get<1>(result) = "D_NOTE"; break;
		case 1101: std::get<1>(result) = "D_NOTE_PLACE"; break;
		case 1102: std::get<1>(result) = "D_NOTE_DELETE"; break;
		case 1103: std::get<1>(result) = "D_NOTE_NAME"; break;
		case 1104: std::get<1>(result) = "D_NOTE_ENTER"; break;
		case 1105: std::get<1>(result) = "D_NOTE_ADOPT_SYMBOL"; break;
		case 1106: std::get<1>(result) = "D_NOTE_CHANGE_SELECTION"; break;
		case 1107: std::get<1>(result) = "D_NOTE_POINTS"; break;
		case 1108: std::get<1>(result) = "D_NOTE_ROUTE"; break;
		case 1109: std::get<1>(result) = "D_NOTE_ROUTE_ADD"; break;
		case 1110: std::get<1>(result) = "D_NOTE_ROUTE_EDIT"; break;
		case 1111: std::get<1>(result) = "D_NOTE_ROUTE_DELETE"; break;
		case 1112: std::get<1>(result) = "D_NOTE_ROUTE_CENTER"; break;
		case 1113: std::get<1>(result) = "D_NOTE_ROUTE_NAME"; break;
		case 1114: std::get<1>(result) = "D_BUILDJOB"; break;
		case 1115: std::get<1>(result) = "D_STATUS"; break;
		case 1116: std::get<1>(result) = "D_STATUS_OVERALL_HEALTH_RECENTER"; break;
		case 1117: std::get<1>(result) = "D_BUILDITEM"; break;
		case 1118: std::get<1>(result) = "D_BITEM_FORBID"; break;
		case 1119: std::get<1>(result) = "D_BITEM_DUMP"; break;
		case 1120: std::get<1>(result) = "D_BITEM_MELT"; break;
		case 1121: std::get<1>(result) = "D_BITEM_HIDE"; break;
		case 1122: std::get<1>(result) = "D_BITEM_NAME"; break;
		case 1123: std::get<1>(result) = "D_LOOK_FORBID"; break;
		case 1124: std::get<1>(result) = "D_LOOK_DUMP"; break;
		case 1125: std::get<1>(result) = "D_LOOK_MELT"; break;
		case 1126: std::get<1>(result) = "D_LOOK_HIDE"; break;
		case 1127: std::get<1>(result) = "D_LOOK_FOLLOW"; break;
		case 1128: std::get<1>(result) = "D_LOOK_ARENA_CREATURE"; break;
		case 1129: std::get<1>(result) = "D_LOOK_ARENA_ADV_MODE"; break;
		case 1130: std::get<1>(result) = "D_LOOK_ARENA_WATER"; break;
		case 1131: std::get<1>(result) = "D_LOOK_ARENA_MAGMA"; break;
		case 1132: std::get<1>(result) = "ARENA_CREATURE_SIDE_DOWN"; break;
		case 1133: std::get<1>(result) = "ARENA_CREATURE_SIDE_UP"; break;
		case 1134: std::get<1>(result) = "ARENA_CREATURE_NEW_ITEM"; break;
		case 1135: std::get<1>(result) = "ARENA_CREATURE_BLANK_LIST"; break;
		case 1136: std::get<1>(result) = "ARENA_CREATURE_REMOVE_ITEM"; break;
		case 1137: std::get<1>(result) = "ARENA_CREATURE_UNDEAD"; break;
		case 1138: std::get<1>(result) = "ARENA_CREATURE_TAME"; break;
		case 1139: std::get<1>(result) = "ARENA_CREATURE_STRING"; break;
		case 1140: std::get<1>(result) = "ARENA_CONFLICT_STATE_1"; break;
		case 1141: std::get<1>(result) = "ARENA_CONFLICT_STATE_2"; break;
		case 1142: std::get<1>(result) = "ARENA_MORALE"; break;
		case 1143: std::get<1>(result) = "ARENA_WEATHER"; break;
		case 1144: std::get<1>(result) = "ARENA_WEATHER_SNOW"; break;
		case 1145: std::get<1>(result) = "ARENA_WEATHER_MUD"; break;
		case 1146: std::get<1>(result) = "ARENA_WEATHER_CLEAR_SPATTER"; break;
		case 1147: std::get<1>(result) = "D_LOOK_ARENA_TREE"; break;
		case 1148: std::get<1>(result) = "ARENA_TREE_FILTER"; break;
		case 1149: std::get<1>(result) = "ARENA_TREE_AGE"; break;
		case 1150: std::get<1>(result) = "D_LOOK_ARENA_MOUNT"; break;
		case 1151: std::get<1>(result) = "ASSIGNTRADE_VIEW"; break;
		case 1152: std::get<1>(result) = "ASSIGNTRADE_STRING"; break;
		case 1153: std::get<1>(result) = "ASSIGNTRADE_EXCLUDE_PROHIBITED"; break;
		case 1154: std::get<1>(result) = "ASSIGNTRADE_PENDING"; break;
		case 1155: std::get<1>(result) = "ASSIGNTRADE_SORT"; break;
		case 1156: std::get<1>(result) = "NOBLELIST_REPLACE"; break;
		case 1157: std::get<1>(result) = "NOBLELIST_SETTINGS"; break;
		case 1158: std::get<1>(result) = "NOBLELIST_CAPITAL"; break;
		case 1159: std::get<1>(result) = "NOBLELIST_VIEW_CANDIDATE"; break;
		case 1160: std::get<1>(result) = "TRADE_VIEW"; break;
		case 1161: std::get<1>(result) = "TRADE_TRADE"; break;
		case 1162: std::get<1>(result) = "TRADE_OFFER"; break;
		case 1163: std::get<1>(result) = "TRADE_SEIZE"; break;
		case 1164: std::get<1>(result) = "MILITARY_ACTIVATE"; break;
		case 1165: std::get<1>(result) = "MILITARY_VIEW"; break;
		case 1166: std::get<1>(result) = "MILITARY_WEAPON"; break;
		case 1167: std::get<1>(result) = "MILITARY_ZOOM"; break;
		case 1168: std::get<1>(result) = "ANNOUNCE_ZOOM"; break;
		case 1169: std::get<1>(result) = "ANNOUNCE_ZOOM_2"; break;
		case 1170: std::get<1>(result) = "UNITJOB_REMOVE_CRE"; break;
		case 1171: std::get<1>(result) = "UNITJOB_ZOOM_CRE"; break;
		case 1172: std::get<1>(result) = "UNITJOB_ZOOM_BUILD"; break;
		case 1173: std::get<1>(result) = "UNITJOB_VIEW_UNIT"; break;
		case 1174: std::get<1>(result) = "UNITJOB_VIEW_JOB"; break;
		case 1175: std::get<1>(result) = "UNITJOB_MANAGER"; break;
		case 1176: std::get<1>(result) = "MANAGER_NEW_ORDER"; break;
		case 1177: std::get<1>(result) = "MANAGER_REMOVE"; break;
		case 1178: std::get<1>(result) = "MANAGER_PROMOTE"; break;
		case 1179: std::get<1>(result) = "MANAGER_MAX"; break;
		case 1180: std::get<1>(result) = "MANAGER_WAGES"; break;
		case 1181: std::get<1>(result) = "MANAGER_CONDITIONS"; break;
		case 1182: std::get<1>(result) = "MANAGER_DETAILS"; break;
		case 1183: std::get<1>(result) = "WORK_ORDER_CONDITION_ADD_ITEM"; break;
		case 1184: std::get<1>(result) = "WORK_ORDER_CONDITION_ADD_ORDER"; break;
		case 1185: std::get<1>(result) = "WORK_ORDER_CONDITION_ITEM_TYPE"; break;
		case 1186: std::get<1>(result) = "WORK_ORDER_CONDITION_ITEM_MATERIAL"; break;
		case 1187: std::get<1>(result) = "WORK_ORDER_CONDITION_ITEM_TRAITS"; break;
		case 1188: std::get<1>(result) = "WORK_ORDER_CONDITION_ITEM_INEQUALITY"; break;
		case 1189: std::get<1>(result) = "WORK_ORDER_CONDITION_ITEM_NUMBER"; break;
		case 1190: std::get<1>(result) = "WORK_ORDER_CONDITION_DELETE"; break;
		case 1191: std::get<1>(result) = "WORK_ORDER_CONDITION_ORDER_ACTIVATION"; break;
		case 1192: std::get<1>(result) = "WORK_ORDER_CONDITION_REAGENTS"; break;
		case 1193: std::get<1>(result) = "WORK_ORDER_CONDITION_PRODUCTS"; break;
		case 1194: std::get<1>(result) = "DESIGNATE_BITEM"; break;
		case 1195: std::get<1>(result) = "DESIGNATE_CLAIM"; break;
		case 1196: std::get<1>(result) = "DESIGNATE_UNCLAIM"; break;
		case 1197: std::get<1>(result) = "DESIGNATE_MELT"; break;
		case 1198: std::get<1>(result) = "DESIGNATE_NO_MELT"; break;
		case 1199: std::get<1>(result) = "DESIGNATE_DUMP"; break;
		case 1200: std::get<1>(result) = "DESIGNATE_NO_DUMP"; break;
		case 1201: std::get<1>(result) = "DESIGNATE_HIDE"; break;
		case 1202: std::get<1>(result) = "DESIGNATE_NO_HIDE"; break;
		case 1203: std::get<1>(result) = "DESIGNATE_DIG"; break;
		case 1204: std::get<1>(result) = "DESIGNATE_DIG_REMOVE_STAIRS_RAMPS"; break;
		case 1205: std::get<1>(result) = "DESIGNATE_TRAFFIC"; break;
		case 1206: std::get<1>(result) = "DESIGNATE_TRAFFIC_HIGH"; break;
		case 1207: std::get<1>(result) = "DESIGNATE_TRAFFIC_NORMAL"; break;
		case 1208: std::get<1>(result) = "DESIGNATE_TRAFFIC_LOW"; break;
		case 1209: std::get<1>(result) = "DESIGNATE_TRAFFIC_RESTRICTED"; break;
		case 1210: std::get<1>(result) = "DESIGNATE_TRAFFIC_INCREASE_WEIGHT"; break;
		case 1211: std::get<1>(result) = "DESIGNATE_TRAFFIC_DECREASE_WEIGHT"; break;
		case 1212: std::get<1>(result) = "DESIGNATE_TRAFFIC_INCREASE_WEIGHT_MORE"; break;
		case 1213: std::get<1>(result) = "DESIGNATE_TRAFFIC_DECREASE_WEIGHT_MORE"; break;
		case 1214: std::get<1>(result) = "DESIGNATE_STAIR_UP"; break;
		case 1215: std::get<1>(result) = "DESIGNATE_STAIR_DOWN"; break;
		case 1216: std::get<1>(result) = "DESIGNATE_STAIR_UPDOWN"; break;
		case 1217: std::get<1>(result) = "DESIGNATE_RAMP"; break;
		case 1218: std::get<1>(result) = "DESIGNATE_CHANNEL"; break;
		case 1219: std::get<1>(result) = "DESIGNATE_CHOP"; break;
		case 1220: std::get<1>(result) = "DESIGNATE_PLANTS"; break;
		case 1221: std::get<1>(result) = "DESIGNATE_SMOOTH"; break;
		case 1222: std::get<1>(result) = "DESIGNATE_ENGRAVE"; break;
		case 1223: std::get<1>(result) = "DESIGNATE_DETAILS"; break;
		case 1224: std::get<1>(result) = "DESIGNATE_FORTIFY"; break;
		case 1225: std::get<1>(result) = "DESIGNATE_TRACK"; break;
		case 1226: std::get<1>(result) = "DESIGNATE_TOGGLE_ENGRAVING"; break;
		case 1227: std::get<1>(result) = "DESIGNATE_STANDARD_MARKER"; break;
		case 1228: std::get<1>(result) = "DESIGNATE_MINE_MODE"; break;
		case 1229: std::get<1>(result) = "DESIGNATE_TOGGLE_MARKER"; break;
		case 1230: std::get<1>(result) = "DESIGNATE_UNDO"; break;
		case 1231: std::get<1>(result) = "DESIGNATE_REMOVE_CONSTRUCTION"; break;
		case 1232: std::get<1>(result) = "ITEM_DESCRIPTION"; break;
		case 1233: std::get<1>(result) = "ITEM_FORBID"; break;
		case 1234: std::get<1>(result) = "ITEM_MELT"; break;
		case 1235: std::get<1>(result) = "ITEM_DUMP"; break;
		case 1236: std::get<1>(result) = "ITEM_HIDE"; break;
		case 1237: std::get<1>(result) = "UNITVIEW_CUSTOMIZE"; break;
		case 1238: std::get<1>(result) = "UNITVIEW_HEALTH"; break;
		case 1239: std::get<1>(result) = "UNITVIEW_RELATIONSHIPS"; break;
		case 1240: std::get<1>(result) = "UNITVIEW_RELATIONSHIPS_ZOOM"; break;
		case 1241: std::get<1>(result) = "UNITVIEW_RELATIONSHIPS_VIEW"; break;
		case 1242: std::get<1>(result) = "UNITVIEW_KILLS"; break;
		case 1243: std::get<1>(result) = "UNITVIEW_GEN"; break;
		case 1244: std::get<1>(result) = "UNITVIEW_INV"; break;
		case 1245: std::get<1>(result) = "UNITVIEW_PRF"; break;
		case 1246: std::get<1>(result) = "UNITVIEW_WND"; break;
		case 1247: std::get<1>(result) = "UNITVIEW_FOLLOW"; break;
		case 1248: std::get<1>(result) = "UNITVIEW_NEXT"; break;
		case 1249: std::get<1>(result) = "UNITVIEW_SLAUGHTER"; break;
		case 1250: std::get<1>(result) = "UNITVIEW_GELD"; break;
		case 1251: std::get<1>(result) = "UNITVIEW_GEN_COMBAT"; break;
		case 1252: std::get<1>(result) = "UNITVIEW_GEN_LABOR"; break;
		case 1253: std::get<1>(result) = "UNITVIEW_GEN_MISC"; break;
		case 1254: std::get<1>(result) = "UNITVIEW_PRF_PROF"; break;
		case 1255: std::get<1>(result) = "UNITVIEW_PRF_PET"; break;
		case 1256: std::get<1>(result) = "UNITVIEW_PRF_EXPEL"; break;
		case 1257: std::get<1>(result) = "UNITVIEW_PRF_VIEW"; break;
		case 1258: std::get<1>(result) = "UNITVIEW_PRF_NEW_SQUAD"; break;
		case 1259: std::get<1>(result) = "UNITVIEW_PRF_REMOVE_FROM_SQUAD"; break;
		case 1260: std::get<1>(result) = "UNITVIEW_PRF_NAME_CURRENT_SQUAD"; break;
		case 1261: std::get<1>(result) = "UNITVIEW_PRF_NAME_SELECTED_SQUAD"; break;
		case 1262: std::get<1>(result) = "UNITVIEW_PRF_OCCUPATION"; break;
		case 1263: std::get<1>(result) = "CUSTOMIZE_UNIT_NICKNAME"; break;
		case 1264: std::get<1>(result) = "CUSTOMIZE_UNIT_PROFNAME"; break;
		case 1265: std::get<1>(result) = "IMAGE_CREATOR_FILTER"; break;
		case 1266: std::get<1>(result) = "IMAGE_CREATOR_NAME"; break;
		case 1267: std::get<1>(result) = "IMAGE_CREATOR_DONE"; break;
		case 1268: std::get<1>(result) = "CIV_RAID"; break;
		case 1269: std::get<1>(result) = "CIV_CENTER_ON_FORT"; break;
		case 1270: std::get<1>(result) = "CIV_HOLDINGS"; break;
		case 1271: std::get<1>(result) = "CIV_MAP_LEGEND"; break;
		case 1272: std::get<1>(result) = "CIV_REMOVE_MISSION"; break;
		case 1273: std::get<1>(result) = "CIV_RESCUE"; break;
		case 1274: std::get<1>(result) = "CIV_RECOVER"; break;
		case 1275: std::get<1>(result) = "CIV_WORLD"; break;
		case 1276: std::get<1>(result) = "CIV_MISSIONS"; break;
		case 1277: std::get<1>(result) = "CIV_MISSION_DETAILS"; break;
		case 1278: std::get<1>(result) = "CIV_MISSION_FREE_CAPTIVES"; break;
		case 1279: std::get<1>(result) = "CIV_MISSION_RELEASE_OTHERS"; break;
		case 1280: std::get<1>(result) = "CIV_MISSION_TAKE_ARTIFACTS"; break;
		case 1281: std::get<1>(result) = "CIV_MISSION_TAKE_ITEMS"; break;
		case 1282: std::get<1>(result) = "CIV_MISSION_TAKE_LIVESTOCK"; break;
		case 1283: std::get<1>(result) = "CIV_MISSION_RAID"; break;
		case 1284: std::get<1>(result) = "CIV_MISSION_PILLAGE"; break;
		case 1285: std::get<1>(result) = "CIV_MISSION_RAZE"; break;
		case 1286: std::get<1>(result) = "CIV_MISSION_TRIBUTE_ONE_TIME"; break;
		case 1287: std::get<1>(result) = "CIV_MISSION_TRIBUTE_ONGOING"; break;
		case 1288: std::get<1>(result) = "CIV_MISSION_CONQUER"; break;
		case 1289: std::get<1>(result) = "CIV_MISSION_DEMAND_SURRENDER"; break;
		case 1290: std::get<1>(result) = "CIV_NEWS"; break;
		case 1291: std::get<1>(result) = "CIV_PEOPLE"; break;
		case 1292: std::get<1>(result) = "CIV_ARTIFACTS"; break;
		case 1293: std::get<1>(result) = "CIV_CIVS"; break;
		case 1294: std::get<1>(result) = "D_MILITARY_CREATE_SQUAD"; break;
		case 1295: std::get<1>(result) = "D_MILITARY_DISBAND_SQUAD"; break;
		case 1296: std::get<1>(result) = "D_MILITARY_CREATE_SUB_SQUAD"; break;
		case 1297: std::get<1>(result) = "D_MILITARY_CANCEL_ORDERS"; break;
		case 1298: std::get<1>(result) = "D_MILITARY_POSITIONS"; break;
		case 1299: std::get<1>(result) = "D_MILITARY_ALERTS"; break;
		case 1300: std::get<1>(result) = "D_MILITARY_ALERTS_ADD"; break;
		case 1301: std::get<1>(result) = "D_MILITARY_ALERTS_DELETE"; break;
		case 1302: std::get<1>(result) = "D_MILITARY_ALERTS_SET"; break;
		case 1303: std::get<1>(result) = "D_MILITARY_ALERTS_NAME"; break;
		case 1304: std::get<1>(result) = "D_MILITARY_ALERTS_SET_RETAIN"; break;
		case 1305: std::get<1>(result) = "D_MILITARY_EQUIP"; break;
		case 1306: std::get<1>(result) = "D_MILITARY_EQUIP_CUSTOMIZE"; break;
		case 1307: std::get<1>(result) = "D_MILITARY_EQUIP_UNIFORM"; break;
		case 1308: std::get<1>(result) = "D_MILITARY_EQUIP_PRIORITY"; break;
		case 1309: std::get<1>(result) = "D_MILITARY_UNIFORMS"; break;
		case 1310: std::get<1>(result) = "D_MILITARY_SUPPLIES"; break;
		case 1311: std::get<1>(result) = "D_MILITARY_SUPPLIES_WATER_DOWN"; break;
		case 1312: std::get<1>(result) = "D_MILITARY_SUPPLIES_WATER_UP"; break;
		case 1313: std::get<1>(result) = "D_MILITARY_SUPPLIES_FOOD_DOWN"; break;
		case 1314: std::get<1>(result) = "D_MILITARY_SUPPLIES_FOOD_UP"; break;
		case 1315: std::get<1>(result) = "D_MILITARY_AMMUNITION"; break;
		case 1316: std::get<1>(result) = "D_MILITARY_AMMUNITION_ADD_ITEM"; break;
		case 1317: std::get<1>(result) = "D_MILITARY_AMMUNITION_REMOVE_ITEM"; break;
		case 1318: std::get<1>(result) = "D_MILITARY_AMMUNITION_LOWER_AMOUNT"; break;
		case 1319: std::get<1>(result) = "D_MILITARY_AMMUNITION_RAISE_AMOUNT"; break;
		case 1320: std::get<1>(result) = "D_MILITARY_AMMUNITION_LOWER_AMOUNT_LOTS"; break;
		case 1321: std::get<1>(result) = "D_MILITARY_AMMUNITION_RAISE_AMOUNT_LOTS"; break;
		case 1322: std::get<1>(result) = "D_MILITARY_AMMUNITION_MATERIAL"; break;
		case 1323: std::get<1>(result) = "D_MILITARY_AMMUNITION_COMBAT"; break;
		case 1324: std::get<1>(result) = "D_MILITARY_AMMUNITION_TRAINING"; break;
		case 1325: std::get<1>(result) = "D_MILITARY_TRAINING"; break;
		case 1326: std::get<1>(result) = "D_MILITARY_SCHEDULE"; break;
		case 1327: std::get<1>(result) = "D_MILITARY_ADD_UNIFORM"; break;
		case 1328: std::get<1>(result) = "D_MILITARY_DELETE_UNIFORM"; break;
		case 1329: std::get<1>(result) = "D_MILITARY_NAME_UNIFORM"; break;
		case 1330: std::get<1>(result) = "D_MILITARY_NAME_SQUAD"; break;
		case 1331: std::get<1>(result) = "D_MILITARY_ADD_ARMOR"; break;
		case 1332: std::get<1>(result) = "D_MILITARY_ADD_PANTS"; break;
		case 1333: std::get<1>(result) = "D_MILITARY_ADD_HELM"; break;
		case 1334: std::get<1>(result) = "D_MILITARY_ADD_GLOVES"; break;
		case 1335: std::get<1>(result) = "D_MILITARY_ADD_BOOTS"; break;
		case 1336: std::get<1>(result) = "D_MILITARY_ADD_SHIELD"; break;
		case 1337: std::get<1>(result) = "D_MILITARY_ADD_WEAPON"; break;
		case 1338: std::get<1>(result) = "D_MILITARY_ADD_MATERIAL"; break;
		case 1339: std::get<1>(result) = "D_MILITARY_ADD_COLOR"; break;
		case 1340: std::get<1>(result) = "D_MILITARY_REPLACE_CLOTHING"; break;
		case 1341: std::get<1>(result) = "D_MILITARY_EXACT_MATCH"; break;
		case 1342: std::get<1>(result) = "D_SQUADS_MOVE"; break;
		case 1343: std::get<1>(result) = "D_SQUADS_KILL"; break;
		case 1344: std::get<1>(result) = "D_SQUADS_KILL_LIST"; break;
		case 1345: std::get<1>(result) = "D_SQUADS_KILL_RECT"; break;
		case 1346: std::get<1>(result) = "D_SQUADS_SCHEDULE"; break;
		case 1347: std::get<1>(result) = "D_SQUADS_CANCEL_ORDER"; break;
		case 1348: std::get<1>(result) = "D_SQUADS_ALERT"; break;
		case 1349: std::get<1>(result) = "D_SQUADS_SELECT_INDIVIDUALS"; break;
		case 1350: std::get<1>(result) = "D_SQUADS_CENTER"; break;
		case 1351: std::get<1>(result) = "D_SQUAD_SCH_SLEEP"; break;
		case 1352: std::get<1>(result) = "D_SQUAD_SCH_CIVILIAN_UNIFORM"; break;
		case 1353: std::get<1>(result) = "D_SQUAD_SCH_GIVE_ORDER"; break;
		case 1354: std::get<1>(result) = "D_SQUAD_SCH_EDIT_ORDER"; break;
		case 1355: std::get<1>(result) = "D_SQUAD_SCH_CANCEL_ORDER"; break;
		case 1356: std::get<1>(result) = "D_SQUAD_SCH_COPY_ORDERS"; break;
		case 1357: std::get<1>(result) = "D_SQUAD_SCH_PASTE_ORDERS"; break;
		case 1358: std::get<1>(result) = "D_SQUAD_SCH_MS_NAME"; break;
		case 1359: std::get<1>(result) = "STRING_A000"; break;
		case 1360: std::get<1>(result) = "STRING_A001"; break;
		case 1361: std::get<1>(result) = "STRING_A002"; break;
		case 1362: std::get<1>(result) = "STRING_A003"; break;
		case 1363: std::get<1>(result) = "STRING_A004"; break;
		case 1364: std::get<1>(result) = "STRING_A005"; break;
		case 1365: std::get<1>(result) = "STRING_A006"; break;
		case 1366: std::get<1>(result) = "STRING_A007"; break;
		case 1367: std::get<1>(result) = "STRING_A008"; break;
		case 1368: std::get<1>(result) = "STRING_A009"; break;
		case 1369: std::get<1>(result) = "STRING_A010"; break;
		case 1370: std::get<1>(result) = "STRING_A011"; break;
		case 1371: std::get<1>(result) = "STRING_A012"; break;
		case 1372: std::get<1>(result) = "STRING_A013"; break;
		case 1373: std::get<1>(result) = "STRING_A014"; break;
		case 1374: std::get<1>(result) = "STRING_A015"; break;
		case 1375: std::get<1>(result) = "STRING_A016"; break;
		case 1376: std::get<1>(result) = "STRING_A017"; break;
		case 1377: std::get<1>(result) = "STRING_A018"; break;
		case 1378: std::get<1>(result) = "STRING_A019"; break;
		case 1379: std::get<1>(result) = "STRING_A020"; break;
		case 1380: std::get<1>(result) = "STRING_A021"; break;
		case 1381: std::get<1>(result) = "STRING_A022"; break;
		case 1382: std::get<1>(result) = "STRING_A023"; break;
		case 1383: std::get<1>(result) = "STRING_A024"; break;
		case 1384: std::get<1>(result) = "STRING_A025"; break;
		case 1385: std::get<1>(result) = "STRING_A026"; break;
		case 1386: std::get<1>(result) = "STRING_A027"; break;
		case 1387: std::get<1>(result) = "STRING_A028"; break;
		case 1388: std::get<1>(result) = "STRING_A029"; break;
		case 1389: std::get<1>(result) = "STRING_A030"; break;
		case 1390: std::get<1>(result) = "STRING_A031"; break;
		case 1391: std::get<1>(result) = "STRING_A032"; break;
		case 1392: std::get<1>(result) = "STRING_A033"; break;
		case 1393: std::get<1>(result) = "STRING_A034"; break;
		case 1394: std::get<1>(result) = "STRING_A035"; break;
		case 1395: std::get<1>(result) = "STRING_A036"; break;
		case 1396: std::get<1>(result) = "STRING_A037"; break;
		case 1397: std::get<1>(result) = "STRING_A038"; break;
		case 1398: std::get<1>(result) = "STRING_A039"; break;
		case 1399: std::get<1>(result) = "STRING_A040"; break;
		case 1400: std::get<1>(result) = "STRING_A041"; break;
		case 1401: std::get<1>(result) = "STRING_A042"; break;
		case 1402: std::get<1>(result) = "STRING_A043"; break;
		case 1403: std::get<1>(result) = "STRING_A044"; break;
		case 1404: std::get<1>(result) = "STRING_A045"; break;
		case 1405: std::get<1>(result) = "STRING_A046"; break;
		case 1406: std::get<1>(result) = "STRING_A047"; break;
		case 1407: std::get<1>(result) = "STRING_A048"; break;
		case 1408: std::get<1>(result) = "STRING_A049"; break;
		case 1409: std::get<1>(result) = "STRING_A050"; break;
		case 1410: std::get<1>(result) = "STRING_A051"; break;
		case 1411: std::get<1>(result) = "STRING_A052"; break;
		case 1412: std::get<1>(result) = "STRING_A053"; break;
		case 1413: std::get<1>(result) = "STRING_A054"; break;
		case 1414: std::get<1>(result) = "STRING_A055"; break;
		case 1415: std::get<1>(result) = "STRING_A056"; break;
		case 1416: std::get<1>(result) = "STRING_A057"; break;
		case 1417: std::get<1>(result) = "STRING_A058"; break;
		case 1418: std::get<1>(result) = "STRING_A059"; break;
		case 1419: std::get<1>(result) = "STRING_A060"; break;
		case 1420: std::get<1>(result) = "STRING_A061"; break;
		case 1421: std::get<1>(result) = "STRING_A062"; break;
		case 1422: std::get<1>(result) = "STRING_A063"; break;
		case 1423: std::get<1>(result) = "STRING_A064"; break;
		case 1424: std::get<1>(result) = "STRING_A065"; break;
		case 1425: std::get<1>(result) = "STRING_A066"; break;
		case 1426: std::get<1>(result) = "STRING_A067"; break;
		case 1427: std::get<1>(result) = "STRING_A068"; break;
		case 1428: std::get<1>(result) = "STRING_A069"; break;
		case 1429: std::get<1>(result) = "STRING_A070"; break;
		case 1430: std::get<1>(result) = "STRING_A071"; break;
		case 1431: std::get<1>(result) = "STRING_A072"; break;
		case 1432: std::get<1>(result) = "STRING_A073"; break;
		case 1433: std::get<1>(result) = "STRING_A074"; break;
		case 1434: std::get<1>(result) = "STRING_A075"; break;
		case 1435: std::get<1>(result) = "STRING_A076"; break;
		case 1436: std::get<1>(result) = "STRING_A077"; break;
		case 1437: std::get<1>(result) = "STRING_A078"; break;
		case 1438: std::get<1>(result) = "STRING_A079"; break;
		case 1439: std::get<1>(result) = "STRING_A080"; break;
		case 1440: std::get<1>(result) = "STRING_A081"; break;
		case 1441: std::get<1>(result) = "STRING_A082"; break;
		case 1442: std::get<1>(result) = "STRING_A083"; break;
		case 1443: std::get<1>(result) = "STRING_A084"; break;
		case 1444: std::get<1>(result) = "STRING_A085"; break;
		case 1445: std::get<1>(result) = "STRING_A086"; break;
		case 1446: std::get<1>(result) = "STRING_A087"; break;
		case 1447: std::get<1>(result) = "STRING_A088"; break;
		case 1448: std::get<1>(result) = "STRING_A089"; break;
		case 1449: std::get<1>(result) = "STRING_A090"; break;
		case 1450: std::get<1>(result) = "STRING_A091"; break;
		case 1451: std::get<1>(result) = "STRING_A092"; break;
		case 1452: std::get<1>(result) = "STRING_A093"; break;
		case 1453: std::get<1>(result) = "STRING_A094"; break;
		case 1454: std::get<1>(result) = "STRING_A095"; break;
		case 1455: std::get<1>(result) = "STRING_A096"; break;
		case 1456: std::get<1>(result) = "STRING_A097"; break;
		case 1457: std::get<1>(result) = "STRING_A098"; break;
		case 1458: std::get<1>(result) = "STRING_A099"; break;
		case 1459: std::get<1>(result) = "STRING_A100"; break;
		case 1460: std::get<1>(result) = "STRING_A101"; break;
		case 1461: std::get<1>(result) = "STRING_A102"; break;
		case 1462: std::get<1>(result) = "STRING_A103"; break;
		case 1463: std::get<1>(result) = "STRING_A104"; break;
		case 1464: std::get<1>(result) = "STRING_A105"; break;
		case 1465: std::get<1>(result) = "STRING_A106"; break;
		case 1466: std::get<1>(result) = "STRING_A107"; break;
		case 1467: std::get<1>(result) = "STRING_A108"; break;
		case 1468: std::get<1>(result) = "STRING_A109"; break;
		case 1469: std::get<1>(result) = "STRING_A110"; break;
		case 1470: std::get<1>(result) = "STRING_A111"; break;
		case 1471: std::get<1>(result) = "STRING_A112"; break;
		case 1472: std::get<1>(result) = "STRING_A113"; break;
		case 1473: std::get<1>(result) = "STRING_A114"; break;
		case 1474: std::get<1>(result) = "STRING_A115"; break;
		case 1475: std::get<1>(result) = "STRING_A116"; break;
		case 1476: std::get<1>(result) = "STRING_A117"; break;
		case 1477: std::get<1>(result) = "STRING_A118"; break;
		case 1478: std::get<1>(result) = "STRING_A119"; break;
		case 1479: std::get<1>(result) = "STRING_A120"; break;
		case 1480: std::get<1>(result) = "STRING_A121"; break;
		case 1481: std::get<1>(result) = "STRING_A122"; break;
		case 1482: std::get<1>(result) = "STRING_A123"; break;
		case 1483: std::get<1>(result) = "STRING_A124"; break;
		case 1484: std::get<1>(result) = "STRING_A125"; break;
		case 1485: std::get<1>(result) = "STRING_A126"; break;
		case 1486: std::get<1>(result) = "STRING_A128"; break;
		case 1487: std::get<1>(result) = "STRING_A129"; break;
		case 1488: std::get<1>(result) = "STRING_A130"; break;
		case 1489: std::get<1>(result) = "STRING_A131"; break;
		case 1490: std::get<1>(result) = "STRING_A132"; break;
		case 1491: std::get<1>(result) = "STRING_A133"; break;
		case 1492: std::get<1>(result) = "STRING_A134"; break;
		case 1493: std::get<1>(result) = "STRING_A135"; break;
		case 1494: std::get<1>(result) = "STRING_A136"; break;
		case 1495: std::get<1>(result) = "STRING_A137"; break;
		case 1496: std::get<1>(result) = "STRING_A138"; break;
		case 1497: std::get<1>(result) = "STRING_A139"; break;
		case 1498: std::get<1>(result) = "STRING_A140"; break;
		case 1499: std::get<1>(result) = "STRING_A141"; break;
		case 1500: std::get<1>(result) = "STRING_A142"; break;
		case 1501: std::get<1>(result) = "STRING_A143"; break;
		case 1502: std::get<1>(result) = "STRING_A144"; break;
		case 1503: std::get<1>(result) = "STRING_A145"; break;
		case 1504: std::get<1>(result) = "STRING_A146"; break;
		case 1505: std::get<1>(result) = "STRING_A147"; break;
		case 1506: std::get<1>(result) = "STRING_A148"; break;
		case 1507: std::get<1>(result) = "STRING_A149"; break;
		case 1508: std::get<1>(result) = "STRING_A150"; break;
		case 1509: std::get<1>(result) = "STRING_A151"; break;
		case 1510: std::get<1>(result) = "STRING_A152"; break;
		case 1511: std::get<1>(result) = "STRING_A153"; break;
		case 1512: std::get<1>(result) = "STRING_A154"; break;
		case 1513: std::get<1>(result) = "STRING_A155"; break;
		case 1514: std::get<1>(result) = "STRING_A156"; break;
		case 1515: std::get<1>(result) = "STRING_A157"; break;
		case 1516: std::get<1>(result) = "STRING_A158"; break;
		case 1517: std::get<1>(result) = "STRING_A159"; break;
		case 1518: std::get<1>(result) = "STRING_A160"; break;
		case 1519: std::get<1>(result) = "STRING_A161"; break;
		case 1520: std::get<1>(result) = "STRING_A162"; break;
		case 1521: std::get<1>(result) = "STRING_A163"; break;
		case 1522: std::get<1>(result) = "STRING_A164"; break;
		case 1523: std::get<1>(result) = "STRING_A165"; break;
		case 1524: std::get<1>(result) = "STRING_A166"; break;
		case 1525: std::get<1>(result) = "STRING_A167"; break;
		case 1526: std::get<1>(result) = "STRING_A168"; break;
		case 1527: std::get<1>(result) = "STRING_A169"; break;
		case 1528: std::get<1>(result) = "STRING_A170"; break;
		case 1529: std::get<1>(result) = "STRING_A171"; break;
		case 1530: std::get<1>(result) = "STRING_A172"; break;
		case 1531: std::get<1>(result) = "STRING_A173"; break;
		case 1532: std::get<1>(result) = "STRING_A174"; break;
		case 1533: std::get<1>(result) = "STRING_A175"; break;
		case 1534: std::get<1>(result) = "STRING_A176"; break;
		case 1535: std::get<1>(result) = "STRING_A177"; break;
		case 1536: std::get<1>(result) = "STRING_A178"; break;
		case 1537: std::get<1>(result) = "STRING_A179"; break;
		case 1538: std::get<1>(result) = "STRING_A180"; break;
		case 1539: std::get<1>(result) = "STRING_A181"; break;
		case 1540: std::get<1>(result) = "STRING_A182"; break;
		case 1541: std::get<1>(result) = "STRING_A183"; break;
		case 1542: std::get<1>(result) = "STRING_A184"; break;
		case 1543: std::get<1>(result) = "STRING_A185"; break;
		case 1544: std::get<1>(result) = "STRING_A186"; break;
		case 1545: std::get<1>(result) = "STRING_A187"; break;
		case 1546: std::get<1>(result) = "STRING_A188"; break;
		case 1547: std::get<1>(result) = "STRING_A189"; break;
		case 1548: std::get<1>(result) = "STRING_A190"; break;
		case 1549: std::get<1>(result) = "STRING_A191"; break;
		case 1550: std::get<1>(result) = "STRING_A192"; break;
		case 1551: std::get<1>(result) = "STRING_A193"; break;
		case 1552: std::get<1>(result) = "STRING_A194"; break;
		case 1553: std::get<1>(result) = "STRING_A195"; break;
		case 1554: std::get<1>(result) = "STRING_A196"; break;
		case 1555: std::get<1>(result) = "STRING_A197"; break;
		case 1556: std::get<1>(result) = "STRING_A198"; break;
		case 1557: std::get<1>(result) = "STRING_A199"; break;
		case 1558: std::get<1>(result) = "STRING_A200"; break;
		case 1559: std::get<1>(result) = "STRING_A201"; break;
		case 1560: std::get<1>(result) = "STRING_A202"; break;
		case 1561: std::get<1>(result) = "STRING_A203"; break;
		case 1562: std::get<1>(result) = "STRING_A204"; break;
		case 1563: std::get<1>(result) = "STRING_A205"; break;
		case 1564: std::get<1>(result) = "STRING_A206"; break;
		case 1565: std::get<1>(result) = "STRING_A207"; break;
		case 1566: std::get<1>(result) = "STRING_A208"; break;
		case 1567: std::get<1>(result) = "STRING_A209"; break;
		case 1568: std::get<1>(result) = "STRING_A210"; break;
		case 1569: std::get<1>(result) = "STRING_A211"; break;
		case 1570: std::get<1>(result) = "STRING_A212"; break;
		case 1571: std::get<1>(result) = "STRING_A213"; break;
		case 1572: std::get<1>(result) = "STRING_A214"; break;
		case 1573: std::get<1>(result) = "STRING_A215"; break;
		case 1574: std::get<1>(result) = "STRING_A216"; break;
		case 1575: std::get<1>(result) = "STRING_A217"; break;
		case 1576: std::get<1>(result) = "STRING_A218"; break;
		case 1577: std::get<1>(result) = "STRING_A219"; break;
		case 1578: std::get<1>(result) = "STRING_A220"; break;
		case 1579: std::get<1>(result) = "STRING_A221"; break;
		case 1580: std::get<1>(result) = "STRING_A222"; break;
		case 1581: std::get<1>(result) = "STRING_A223"; break;
		case 1582: std::get<1>(result) = "STRING_A224"; break;
		case 1583: std::get<1>(result) = "STRING_A225"; break;
		case 1584: std::get<1>(result) = "STRING_A226"; break;
		case 1585: std::get<1>(result) = "STRING_A227"; break;
		case 1586: std::get<1>(result) = "STRING_A228"; break;
		case 1587: std::get<1>(result) = "STRING_A229"; break;
		case 1588: std::get<1>(result) = "STRING_A230"; break;
		case 1589: std::get<1>(result) = "STRING_A231"; break;
		case 1590: std::get<1>(result) = "STRING_A232"; break;
		case 1591: std::get<1>(result) = "STRING_A233"; break;
		case 1592: std::get<1>(result) = "STRING_A234"; break;
		case 1593: std::get<1>(result) = "STRING_A235"; break;
		case 1594: std::get<1>(result) = "STRING_A236"; break;
		case 1595: std::get<1>(result) = "STRING_A237"; break;
		case 1596: std::get<1>(result) = "STRING_A238"; break;
		case 1597: std::get<1>(result) = "STRING_A239"; break;
		case 1598: std::get<1>(result) = "STRING_A240"; break;
		case 1599: std::get<1>(result) = "STRING_A241"; break;
		case 1600: std::get<1>(result) = "STRING_A242"; break;
		case 1601: std::get<1>(result) = "STRING_A243"; break;
		case 1602: std::get<1>(result) = "STRING_A244"; break;
		case 1603: std::get<1>(result) = "STRING_A245"; break;
		case 1604: std::get<1>(result) = "STRING_A246"; break;
		case 1605: std::get<1>(result) = "STRING_A247"; break;
		case 1606: std::get<1>(result) = "STRING_A248"; break;
		case 1607: std::get<1>(result) = "STRING_A249"; break;
		case 1608: std::get<1>(result) = "STRING_A250"; break;
		case 1609: std::get<1>(result) = "STRING_A251"; break;
		case 1610: std::get<1>(result) = "STRING_A252"; break;
		case 1611: std::get<1>(result) = "STRING_A253"; break;
		case 1612: std::get<1>(result) = "STRING_A254"; break;
		case 1613: std::get<1>(result) = "STRING_A255"; break;
		case 1614: std::get<1>(result) = "KEYBINDING_COMPLETE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_language_name_category_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 62: std::get<1>(result) = "EntityMerchantCompany"; break;
		case 63: std::get<1>(result) = "anon_1"; break;
		case 64: std::get<1>(result) = "EntityMerchantCompany2"; break;
		case 65: std::get<1>(result) = "anon_2"; break;
		case 66: std::get<1>(result) = "anon_3"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_layer_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "Surface"; break;
		case 0: std::get<1>(result) = "Cavern1"; break;
		case 1: std::get<1>(result) = "Cavern2"; break;
		case 2: std::get<1>(result) = "Cavern3"; break;
		case 3: std::get<1>(result) = "MagmaSea"; break;
		case 4: std::get<1>(result) = "Underworld"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_activity_entry_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "TrainingSession"; break;
		case 1: std::get<1>(result) = "IndividualSkillDrill"; break;
		case 2: std::get<1>(result) = "Conflict"; break;
		case 3: std::get<1>(result) = "anon_1"; break;
		case 4: std::get<1>(result) = "anon_2"; break;
		case 5: std::get<1>(result) = "Conversation"; break;
		case 6: std::get<1>(result) = "anon_3"; break;
		case 7: std::get<1>(result) = "Prayer"; break;
		case 8: std::get<1>(result) = "Socialize"; break;
		case 9: std::get<1>(result) = "Research"; break;
		case 10: std::get<1>(result) = "FillServiceOrder"; break;
		case 11: std::get<1>(result) = "Read"; break;
		case 12: std::get<1>(result) = "Play"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_general_ref_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 69: std::get<1>(result) = "UNIT_INTERROGATEE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_histfig_site_link_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 8: std::get<1>(result) = "PRISON_ABSTRACT_BUILDING"; break;
		case 9: std::get<1>(result) = "PRISON_SITE_BUILDING_PROFILE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_histfig_hf_link_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 14: std::get<1>(result) = "FORMER_SPOUSE"; break;
		case 15: std::get<1>(result) = "DECEASED_SPOUSE"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_entity_entity_link_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 2: std::get<1>(result) = "RELIGIOUS"; std::get<2>(result) = "Seen between religion and merc company."; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_entity_site_link_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Claim"; break;
		case 1: std::get<1>(result) = "Unk_1"; break;
		case 2: std::get<1>(result) = "Foreign_Crime"; break;
		case 3: std::get<1>(result) = "Unk_3"; break;
		case 4: std::get<1>(result) = "Local_Activity"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_job_skill_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 135: std::get<1>(result) = "INTRIGUE"; break;
		case 136: std::get<1>(result) = "RIDING"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_ui_sidebar_mode_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 55: std::get<1>(result) = "BuildingLocationInfo"; break;
		case 56: std::get<1>(result) = "ZonesLocationInfo"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_unit_thought_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 243: std::get<1>(result) = "anon_1"; break;
		case 244: std::get<1>(result) = "anon_2"; break;
		case 245: std::get<1>(result) = "SiteLecture"; break;
		case 246: std::get<1>(result) = "SitePerformance"; break;
		case 247: std::get<1>(result) = "AcceptedBribe"; break;
		case 248: std::get<1>(result) = "EmbezzledFunds"; break;
		case 249: std::get<1>(result) = "CutOfCorruptFunds"; break;
		case 250: std::get<1>(result) = "Abducted"; break;
		case 251: std::get<1>(result) = "FromAfar"; break;
		case 252: std::get<1>(result) = "AcceptedTemplePetition"; break;
		case 253: std::get<1>(result) = "EstablishedTemple"; break;
		case 254: std::get<1>(result) = "RejectedTemplePetition"; break;
		case 255: std::get<1>(result) = "IgnoredTemplePetition"; break;
		case 256: std::get<1>(result) = "AbandonedTemplePetition"; break;
		case 257: std::get<1>(result) = "anon_3"; break;
		case 258: std::get<1>(result) = "AcceptedGuildhallPetition"; break;
		case 259: std::get<1>(result) = "EstablishedGuildhallPetition"; break;
		case 260: std::get<1>(result) = "RejectedGuildhallPetition"; break;
		case 261: std::get<1>(result) = "IgnoredGuildhallPetition"; break;
		case 262: std::get<1>(result) = "AbandonedGuildhallPetition"; break;
		case 263: std::get<1>(result) = "InfiltrationMission"; break;
		case 264: std::get<1>(result) = "BreakUp"; break;
		case 265: std::get<1>(result) = "Divorce"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_goal_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 13: std::get<1>(result) = "ATTAINING_RANK_IN_SOCIETY"; break;
		case 14: std::get<1>(result) = "BATHING_THE_WORLD_IN_CHAOS"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_misc_trait_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 59: std::get<1>(result) = "anon_18"; break;
		case 60: std::get<1>(result) = "anon_19"; break;
		case 61: std::get<1>(result) = "anon_20"; break;
		case 62: std::get<1>(result) = "anon_21"; break;
		case 63: std::get<1>(result) = "anon_22"; break;
		case 64: std::get<1>(result) = "anon_23"; break;
		case 65: std::get<1>(result) = "anon_24"; break;
		case 66: std::get<1>(result) = "anon_25"; break;
		case 67: std::get<1>(result) = "anon_26"; break;
		case 68: std::get<1>(result) = "CitizenshipCooldown"; std::get<2>(result) = "starts at 1 year, unit will not re-request citizenship during this time, auto-decrement"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_embark_finder_option_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 9: std::get<1>(result) = "AquiferLight"; break;
		case 10: std::get<1>(result) = "AquiferHeavy"; break;
		case 11: std::get<1>(result) = "River"; break;
		case 12: std::get<1>(result) = "UndergroundRiver"; break;
		case 13: std::get<1>(result) = "UndergroundPool"; break;
		case 14: std::get<1>(result) = "MagmaPool"; break;
		case 15: std::get<1>(result) = "MagmaPipe"; break;
		case 16: std::get<1>(result) = "Chasm"; break;
		case 17: std::get<1>(result) = "BottomlessPit"; break;
		case 18: std::get<1>(result) = "OtherFeatures"; break;
		case 19: std::get<1>(result) = "ShallowMetal"; break;
		case 20: std::get<1>(result) = "DeepMetal"; break;
		case 21: std::get<1>(result) = "Soil"; break;
		case 22: std::get<1>(result) = "Clay"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_export_map_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -3: std::get<1>(result) = "anon_1"; std::get<2>(result) = "-hf#"; break;
		case -2: std::get<1>(result) = "anon_2"; std::get<2>(result) = "-rel#"; break;
		case 0: std::get<1>(result) = "standard_biome_site_map"; break;
		case 1: std::get<1>(result) = "elevations_including_lake_and_ocean_floors"; break;
		case 2: std::get<1>(result) = "elevations_respecting_water_level"; break;
		case 3: std::get<1>(result) = "biome"; break;
		case 4: std::get<1>(result) = "hydrosphere"; break;
		case 5: std::get<1>(result) = "temperature"; break;
		case 6: std::get<1>(result) = "rainfall"; break;
		case 7: std::get<1>(result) = "drainage"; break;
		case 8: std::get<1>(result) = "savagery"; break;
		case 9: std::get<1>(result) = "volcanism"; break;
		case 10: std::get<1>(result) = "current_vegetation"; break;
		case 11: std::get<1>(result) = "evil"; break;
		case 12: std::get<1>(result) = "salinity"; break;
		case 13: std::get<1>(result) = "structures_fields_roads_etc"; break;
		case 14: std::get<1>(result) = "trade"; break;
		case 15: std::get<1>(result) = "nobility_holdings"; break;
		case 16: std::get<1>(result) = "diplomacy"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_abstract_building_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 10: std::get<1>(result) = "COUNTING_HOUSE"; break;
		case 11: std::get<1>(result) = "GUILDHALL"; break;
		case 12: std::get<1>(result) = "TOWER"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_abstract_building_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Unk0"; break;
		case 1: std::get<1>(result) = "Unk1"; break;
		case 2: std::get<1>(result) = "Unk2"; std::get<2>(result) = "gets toggled when an adventurer has visited it."; break;
		...
		case 6: std::get<1>(result) = "OnlyMembers"; break;
...
std::tuple<int64_t, std::string, std::string> get_temple_deity_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Deity"; break;
		case 1: std::get<1>(result) = "Religion"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_world_site_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 5: std::get<1>(result) = "anon_4"; break;
		case 6: std::get<1>(result) = "anon_5"; break;
		case 7: std::get<1>(result) = "anon_6"; break;
		case 8: std::get<1>(result) = "anon_7"; break;
		case 9: std::get<1>(result) = "CaveCapital"; std::get<2>(result) = "set on caves (only) that have capital entity links, i.e. Kobold civs in vanilla"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_fortress_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "NONE"; break;
		case 0: std::get<1>(result) = "CASTLE"; break;
		case 1: std::get<1>(result) = "TOWER"; break;
		case 2: std::get<1>(result) = "MONASTERY"; break;
		case 3: std::get<1>(result) = "FORT"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_monument_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "NONE"; break;
		case 0: std::get<1>(result) = "TOMB"; break;
		case 1: std::get<1>(result) = "VAULT"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_lair_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "NONE"; break;
		case 0: std::get<1>(result) = "SIMPLE_MOUND"; std::get<2>(result) = "Night creatures"; break;
		case 1: std::get<1>(result) = "SIMPLE_BURROW"; std::get<2>(result) = "animal, (semi)megabeast, night creature(!)"; break;
		case 2: std::get<1>(result) = "LABYRINTH"; break;
		case 3: std::get<1>(result) = "SHRINE"; break;
		case 4: std::get<1>(result) = "WILDERNESS_LOCATION"; std::get<2>(result) = "In mountains, hosting Rocs in vanilla"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_site_realization_building_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 23: std::get<1>(result) = "counting_house"; break;
		case 24: std::get<1>(result) = "guild_hall"; break;
		case 25: std::get<1>(result) = "city_tower"; break;
		case 26: std::get<1>(result) = "shrine"; break;
		case 27: std::get<1>(result) = "anon_1"; break;
		case 28: std::get<1>(result) = "dormitory"; break;
		case 29: std::get<1>(result) = "dininghall"; break;
		case 30: std::get<1>(result) = "necromancer_tower"; break;
		case 31: std::get<1>(result) = "barrow"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_body_abusedst__T_abuse_data__T_Piled__T_pile_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_history_event_body_abusedst__T_abuse_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Impaled"; break;
		case 1: std::get<1>(result) = "Piled"; break;
		case 2: std::get<1>(result) = "Flayed"; break;
		case 3: std::get<1>(result) = "Hung"; break;
		case 4: std::get<1>(result) = "Mutilated"; break;
		case 5: std::get<1>(result) = "Animated"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_job_item_ref__T_role_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Other"; std::get<2>(result) = "eat, drink, pickup equipment"; break;
		case 1: std::get<1>(result) = "Reagent"; break;
		case 2: std::get<1>(result) = "Hauled"; break;
		case 3: std::get<1>(result) = "LinkToTarget"; std::get<2>(result) = "used when linking a lever to a building, not sure if swapped"; break;
		case 4: std::get<1>(result) = "LinkToTrigger"; break;
		case 5: std::get<1>(result) = "anon_1"; break;
		case 6: std::get<1>(result) = "TargetContainer"; break;
		case 7: std::get<1>(result) = "QueuedContainer"; std::get<2>(result) = "queued to be put in a container"; break;
		case 8: std::get<1>(result) = "PushHaulVehicle"; std::get<2>(result) = "wheelbarrow"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_knowledge_scholar_category_flag__T_flag_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "flags_0"; break;
		case 1: std::get<1>(result) = "flags_1"; break;
		case 2: std::get<1>(result) = "flags_2"; break;
		case 3: std::get<1>(result) = "flags_3"; break;
		case 4: std::get<1>(result) = "flags_4"; break;
		case 5: std::get<1>(result) = "flags_5"; break;
		case 6: std::get<1>(result) = "flags_6"; break;
		case 7: std::get<1>(result) = "flags_7"; break;
		case 8: std::get<1>(result) = "flags_8"; break;
		case 9: std::get<1>(result) = "flags_9"; break;
		case 10: std::get<1>(result) = "flags_10"; break;
		case 11: std::get<1>(result) = "flags_11"; break;
		case 12: std::get<1>(result) = "flags_12"; break;
		case 13: std::get<1>(result) = "flags_13"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_history_event_collection_battlest__T_attacker_merc_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "mercenaries"; break;
		case 1: std::get<1>(result) = "mercenary_scouts"; break;
		case 2: std::get<1>(result) = "unk_2"; break;
		default: break;
	}
	return result;
...
std::tuple<int64_t, std::string, std::string> get_army_controller__T_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "t0"; break;
		case 1: std::get<1>(result) = "t1"; break;
		case 2: std::get<1>(result) = "SentToInvade"; break;
		case 3: std::get<1>(result) = "t3"; break;
		case 4: std::get<1>(result) = "t4"; std::get<2>(result) = "Seen on army_controller entries of armies referenced by t2 controllers (which do not refer to the t2 entries). These t4 entries are not in the 'all' vector"; break;
		case 5: std::get<1>(result) = "t5"; break;
		case 6: std::get<1>(result) = "t6"; break;
		case 7: std::get<1>(result) = "t7"; break;
		case 8: std::get<1>(result) = "t8"; break;
		case 9: std::get<1>(result) = "t9"; break;
		case 10: std::get<1>(result) = "t10"; break;
		case 11: std::get<1>(result) = "t11"; break;
		case 12: std::get<1>(result) = "SentToTributary"; break;
		case 13: std::get<1>(result) = "t13"; break;
		case 14: std::get<1>(result) = "t14"; break;
		case 15: std::get<1>(result) = "t15"; break;
		case 16: std::get<1>(result) = "t16"; break;
		case 17: std::get<1>(result) = "t17"; std::get<2>(result) = "seen for artifact questers"; break;
		case 18: std::get<1>(result) = "t18"; break;
		case 19: std::get<1>(result) = "t19"; break;
		case 20: std::get<1>(result) = "t20"; break;
		case 21: std::get<1>(result) = "t21"; break;
		case 22: std::get<1>(result) = "t22"; break;
		case 23: std::get<1>(result) = "t23"; break;
		case 24: std::get<1>(result) = "VillainVisiting"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_historical_figure_info__T_relationships__T_intrigues__T_plots__T_plot_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Grow_Funding_Network"; break;
		case 1: std::get<1>(result) = "Grow_Asset_Network"; break;
		case 2: std::get<1>(result) = "Acquire_Artifact"; break;
		case 3: std::get<1>(result) = "Grow_Corruption_Network"; break;
		case 4: std::get<1>(result) = "Attain_Rank"; break;
		case 5: std::get<1>(result) = "Assassinate_Actor"; break;
		case 6: std::get<1>(result) = "unk5_t6"; break;
		case 7: std::get<1>(result) = "Frame_Actor"; break;
		case 8: std::get<1>(result) = "Kidnap_Actor"; break;
		case 9: std::get<1>(result) = "Sabotage_Actor"; break;
		case 10: std::get<1>(result) = "Direct_War_To_Actor"; break;
		case 11: std::get<1>(result) = "Corrupt_Actors_Government"; break;
		case 12: std::get<1>(result) = "Counterintelligence"; break;
		case 13: std::get<1>(result) = "Become_Immortal"; break;
		case 14: std::get<1>(result) = "Undead_World_Conquest"; break;
		case 15: std::get<1>(result) = "Infiltrate_Society"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_unit_action_data_attack__T_unk_4__T_wrestle_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Wrestle"; break;
		case 1: std::get<1>(result) = "Grab"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_viewscreen_choose_start_sitest__T_finder__T_finder_state_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "None"; break;
		case 0: std::get<1>(result) = "Searching"; break;
		case 1: std::get<1>(result) = "NoResult"; break;
		case 2: std::get<1>(result) = "Partial"; break;
		case 3: std::get<1>(result) = "Suitable"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_viewscreen_justicest__T_cur_column_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 3: std::get<1>(result) = "InterrogateChoices"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_setup_character_info__T_page_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 5: std::get<1>(result) = "Skills"; break;
		case 6: std::get<1>(result) = "Appearance"; break;
		case 7: std::get<1>(result) = "Personality"; break;
		case 8: std::get<1>(result) = "Background"; break;
		case 9: std::get<1>(result) = "Equipment"; break;
		case 10: std::get<1>(result) = "MountsAndPets"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_setup_character_info__T_sel_trait_column_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_viewscreen_setupadventurest__T_page_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 5: std::get<1>(result) = "Appearance"; break;
		case 6: std::get<1>(result) = "Personality"; break;
		case 7: std::get<1>(result) = "Background"; break;
		case 8: std::get<1>(result) = "Equipment"; break;
		case 9: std::get<1>(result) = "MountsAndPets"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_viewscreen_setupadventurest__T_status_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_incident__T_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "Combat"; break;
		case 1: std::get<1>(result) = "Crime"; std::get<2>(result) = "Visible indirectly through convictions or crime effects (e.g. killing/maiming someone)"; break;
		case 2: std::get<1>(result) = "t2"; break;
		case 3: std::get<1>(result) = "t3"; break;
		case 4: std::get<1>(result) = "t4"; break;
		case 5: std::get<1>(result) = "t5"; break;
		case 6: std::get<1>(result) = "Performance"; break;
		case 7: std::get<1>(result) = "t7"; std::get<2>(result) = "Looks like quester, i.e. mercs looking for an artifact. Base on a single correlation of activities seen, though."; break;
		case 8: std::get<1>(result) = "t8"; break;
		case 9: std::get<1>(result) = "t9"; break;
		case 10: std::get<1>(result) = "t10"; break;
		default: break;
...
std::tuple<int64_t, std::string, std::string> get_crime__T_mode_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 11: std::get<1>(result) = "Embezzlement"; break;
		case 12: std::get<1>(result) = "AttemptedMurder"; break;
		case 13: std::get<1>(result) = "Kidnapping"; break;
		case 14: std::get<1>(result) = "AttemptedKidnapping"; break;
		case 15: std::get<1>(result) = "AttemptedTheft"; break;
		case 16: std::get<1>(result) = "Treason"; break;
		case 17: std::get<1>(result) = "Espionage"; break;
		case 18: std::get<1>(result) = "Bribery"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_world__T_arena_spawn__T_tame_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "NotTame"; break;
		case 1: std::get<1>(result) = "Tame"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_enum_decoded(const NodeEnum* p_node)
{
	switch(p_node->m_df_type)
	{
		...
		case DF_Type::unk_scale_enum_type: return get_unk_scale_enum_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::crime_type: return get_crime_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::agreement_details_type: return get_agreement_details_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::next_global_id: return get_next_global_id_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::justification: return get_justification_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::reputation_type: return get_reputation_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::whereabouts_type: return get_whereabouts_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::death_condition_type: return get_death_condition_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::plot_role_type: return get_plot_role_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::plot_strategy_type: return get_plot_strategy_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::vague_relationship_type: return get_vague_relationship_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::identity_type: return get_identity_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::architectural_element: return get_architectural_element_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::history_event_flags: return get_history_event_flags_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::history_event_war_attacked_sitest__T_unk_1: return get_history_event_war_attacked_sitest__T_unk_1_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::artifact_claim_type: return get_artifact_claim_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::interaction_flags: return get_interaction_flags_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::itemdef_flags: return get_itemdef_flags_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::layer_type: return get_layer_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::activity_entry_type: return get_activity_entry_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::entity_site_link_type: return get_entity_site_link_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::export_map_type: return get_export_map_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::temple_deity_type: return get_temple_deity_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::fortress_type: return get_fortress_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::monument_type: return get_monument_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::lair_type: return get_lair_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::history_event_body_abusedst__T_abuse_data__T_Piled__T_pile_type: return get_history_event_body_abusedst__T_abuse_data__T_Piled__T_pile_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::knowledge_scholar_category_flag__T_flag_type: return get_knowledge_scholar_category_flag__T_flag_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::history_event_collection_battlest__T_attacker_merc_type: return get_history_event_collection_battlest__T_attacker_merc_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::army_controller__T_type: return get_army_controller__T_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::historical_figure_info__T_relationships__T_intrigues__T_plots__T_plot_type: return get_historical_figure_info__T_relationships__T_intrigues__T_plots__T_plot_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::unit_action_data_attack__T_unk_4__T_wrestle_type: return get_unit_action_data_attack__T_unk_4__T_wrestle_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::viewscreen_choose_start_sitest__T_finder__T_finder_state: return get_viewscreen_choose_start_sitest__T_finder__T_finder_state_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::setup_character_info__T_page: return get_setup_character_info__T_page_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::setup_character_info__T_sel_trait_column: return get_setup_character_info__T_sel_trait_column_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::viewscreen_setupadventurest__T_status: return get_viewscreen_setupadventurest__T_status_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::incident__T_type: return get_incident__T_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::crime__T_mode: return get_crime__T_mode_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::world__T_arena_spawn__T_tame: return get_world__T_arena_spawn__T_tame_value_decoded(p_node->m_base_type, p_node->m_address);
		default: break;
	}
