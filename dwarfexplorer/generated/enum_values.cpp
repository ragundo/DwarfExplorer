...
std::tuple<int64_t, std::string, std::string> get_creature_raw_flags_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		case 0: std::get<1>(result) = "unk_wagon"; std::get<2>(result) = "[EQUIPMENT_WAGON]"; break;
		case 1: std::get<1>(result) = "EQUIPMENT_WAGON"; std::get<2>(result) = "[EQUIPMENT_WAGON] as well"; break;
		...
		case 66: std::get<1>(result) = "NOT_ASEXUAL"; std::get<2>(result) = "Presence of any CASTE tag"; break;
		case 67: std::get<1>(result) = "MALE_AND_FEMALE"; std::get<2>(result) = "capable of breeding, [MALE] and [FEMALE] tags"; break;
		case 68: std::get<1>(result) = "MALE"; std::get<2>(result) = "[MALE]"; break;
		case 69: std::get<1>(result) = "FEMALE"; std::get<2>(result) = "[FEMALE]"; break;
		case 70: std::get<1>(result) = "any_vermin"; break;
		case 71: std::get<1>(result) = "CASTE_CAN_LEARN"; break;
		case 72: std::get<1>(result) = "CASTE_VERMIN_HATEABLE"; std::get<2>(result) = "[VERMIN_HATEABLE]"; break;
		case 73: std::get<1>(result) = "CIVILIZATION_BUILDING"; std::get<2>(result) = "included in entity_defaults.txt"; break;
		case 74: std::get<1>(result) = "CASTE_LARGE_PREDATOR"; std::get<2>(result) = "[LARGE_PREDATOR]"; break;
		case 75: std::get<1>(result) = "CASTE_CURIOUSBEAST"; break;
		case 76: std::get<1>(result) = "CASTE_BENIGN"; std::get<2>(result) = "[BENIGN]"; break;
		case 77: std::get<1>(result) = "CASTE_NATURAL"; std::get<2>(result) = "[NATURAL]"; break;
		case 78: std::get<1>(result) = "CASTE_MEGABEAST"; std::get<2>(result) = "[MEGABEAST]"; break;
		case 79: std::get<1>(result) = "CASTE_SEMIMEGABEAST"; std::get<2>(result) = "[SEMIMEGABEAST]"; break;
		case 80: std::get<1>(result) = "CASTE_POWER"; break;
		case 81: std::get<1>(result) = "CASTE_VERMIN_MICRO"; std::get<2>(result) = "[VERMIN_MICRO]"; break;
		case 82: std::get<1>(result) = "CASTE_NOT_FIREIMMUNE"; break;
		case 83: std::get<1>(result) = "CASTE_MUST_BREATHE_AIR"; break;
		case 84: std::get<1>(result) = "CASTE_MUST_BREATHE_WATER"; std::get<2>(result) = "[AQUATIC]"; break;
		case 85: std::get<1>(result) = "unk_55"; break;
		case 86: std::get<1>(result) = "CASTE_SWIMS_LEARNED"; break;
		case 87: std::get<1>(result) = "CASTE_COMMON_DOMESTIC"; std::get<2>(result) = "[COMMON_DOMESTIC]"; break;
		case 88: std::get<1>(result) = "CASTE_UTTERANCES"; std::get<2>(result) = "[UTTERANCES], [FLEEQUICK], and [MENT_ATT_RATES]"; break;
		case 89: std::get<1>(result) = "CASTE_CAN_SPEAK"; break;
		case 90: std::get<1>(result) = "CASTE_FEATURE_BEAST"; std::get<2>(result) = "[FEATURE_BEAST]"; break;
		case 91: std::get<1>(result) = "GENERATED"; std::get<2>(result) = "[GENERATED]"; break;
		case 92: std::get<1>(result) = "CASTE_TITAN"; std::get<2>(result) = "[TITAN]"; break;
		case 93: std::get<1>(result) = "CASTE_UNIQUE_DEMON"; std::get<2>(result) = "[UNIQUE_DEMON]"; break;
		case 94: std::get<1>(result) = "DOES_NOT_EXIST"; std::get<2>(result) = "[DOES_NOT_EXIST] (also missing [DESCRIPTION], [BODY], and [BODY_SIZE])"; break;
		case 95: std::get<1>(result) = "CASTE_NOT_LIVING"; std::get<2>(result) = "[NOT_LIVING]"; break;
		case 96: std::get<1>(result) = "CASTE_MISCHIEVOUS"; std::get<2>(result) = "[MISCHIEVOUS]"; break;
		case 97: std::get<1>(result) = "CASTE_FLIER"; std::get<2>(result) = "[FLIER]"; break;
		case 98: std::get<1>(result) = "CASTE_DEMON"; break;
		case 99: std::get<1>(result) = "CASTE_NIGHT_CREATURE_ANY"; break;
		case 100: std::get<1>(result) = "CASTE_NIGHT_CREATURE_HUNTER"; std::get<2>(result) = "[NIGHT_CREATURE_HUNTER]"; break;
		case 101: std::get<1>(result) = "CASTE_NIGHT_CREATURE_BOGEYMAN"; std::get<2>(result) = "[NIGHT_CREATURE_BOGEYMAN]"; break;
		case 102: std::get<1>(result) = "CASTE_CARNIVORE"; break;
		case 103: std::get<1>(result) = "ARTIFICIAL_HIVEABLE"; std::get<2>(result) = "[ARTIFICIAL_HIVEABLE], plus bee specific tags"; break;
		case 104: std::get<1>(result) = "UBIQUITOUS"; std::get<2>(result) = "[UBIQUITOUS]"; break;
		case 105: std::get<1>(result) = "LIVING"; std::get<2>(result) = "does not have [NOT_LIVING] tag"; break;
		case 106: std::get<1>(result) = "CASTE_SUPERNATURAL"; std::get<2>(result) = "[SUPERNATURAL]"; break;
		case 107: std::get<1>(result) = "CASTE_BLOOD"; std::get<2>(result) = "[BLOOD]"; break;
		case 108: std::get<1>(result) = "CASTE_GRAZER"; std::get<2>(result) = "[STANDARD_GRAZER]"; break;
		case 109: std::get<1>(result) = "IMMOBILE"; std::get<2>(result) = "[IMMOBILE]"; break;
		case 110: std::get<1>(result) = "LOCAL_POPS_CONTROLLABLE"; std::get<2>(result) = "[LOCAL_POPS_CONTROLLABLE]"; break;
		case 111: std::get<1>(result) = "OUTSIDER_CONTROLLABLE"; std::get<2>(result) = "[OUTSIDER_CONTROLLABLE]"; break;
		case 112: std::get<1>(result) = "LOCAL_POPS_PRODUCE_HEROES"; std::get<2>(result) = "[LOCAL_POPS_PRODUCE_HEROES]"; break;
		case 113: std::get<1>(result) = "unk_71"; break;
		case 114: std::get<1>(result) = "unk_72"; break;
		case 115: std::get<1>(result) = "FLIER"; std::get<2>(result) = "[FLIER]"; break;
		case 116: std::get<1>(result) = "SLOW_LEARNER"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_agreement_details_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 10: std::get<1>(result) = "anon_1"; break;
...
std::tuple<int64_t, std::string, std::string> get_unit_thought_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 251: std::get<1>(result) = "anon_9"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_agreement_details_data_location__T_anon_5_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case 1: std::get<1>(result) = "Minor"; std::get<2>(result) = "temple or guildhall"; break;
		case 2: std::get<1>(result) = "Major"; std::get<2>(result) = "temple complex or grand guildhall"; break;
		default: break;
	}
	return result;
}
...
std::tuple<int64_t, std::string, std::string> get_army_controller__T_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 12: std::get<1>(result) = "t12"; break;
...
std::tuple<int64_t, std::string, std::string> get_historical_figure_info__T_relationships__T_unk__T_unk5__T_unk5_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
		case -1: std::get<1>(result) = "unk5_none"; break;
		case 0: std::get<1>(result) = "unk5_t0"; break;
		case 1: std::get<1>(result) = "unk5_t1"; break;
		case 2: std::get<1>(result) = "unk5_t2"; break;
		case 3: std::get<1>(result) = "unk5_t3"; break;
		case 4: std::get<1>(result) = "unk5_t4"; break;
		case 5: std::get<1>(result) = "unk5_t5"; break;
		case 6: std::get<1>(result) = "unk5_t6"; break;
		case 7: std::get<1>(result) = "unk5_t7"; break;
		case 8: std::get<1>(result) = "unk5_t8"; break;
		case 9: std::get<1>(result) = "unk5_t9"; break;
		case 10: std::get<1>(result) = "unk5_t10"; break;
		case 11: std::get<1>(result) = "unk5_t11"; break;
		case 12: std::get<1>(result) = "unk5_t12"; break;
		case 13: std::get<1>(result) = "unk5_t13"; break;
		case 14: std::get<1>(result) = "unk5_t14"; break;
		case 15: std::get<1>(result) = "unk5_t15"; break;
		default: break;
	}
	return result;
}

std::tuple<int64_t, std::string, std::string> get_unit_action__T_data__T_attack__T_unk_4__T_wrestle_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_incident__T_subtype_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	std::tuple<int64_t, std::string, std::string> result = std::make_tuple(cast(p_base_type, p_address), "UNKNOWN-VALUE", "");
	switch (std::get<0>(result))
	{
...
std::tuple<int64_t, std::string, std::string> get_enum_decoded(const NodeEnum* p_node)
{
	switch(p_node->m_df_type)
	{
		...
		case DF_Type::agreement_details_data_location__T_anon_5: return get_agreement_details_data_location__T_anon_5_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::historical_figure_info__T_relationships__T_unk__T_unk5__T_unk5_type: return get_historical_figure_info__T_relationships__T_unk__T_unk5__T_unk5_type_value_decoded(p_node->m_base_type, p_node->m_address);
		case DF_Type::unit_action__T_data__T_attack__T_unk_4__T_wrestle_type: return get_unit_action__T_data__T_attack__T_unk_4__T_wrestle_type_value_decoded(p_node->m_base_type, p_node->m_address);
		...
		case DF_Type::incident__T_subtype: return get_incident__T_subtype_value_decoded(p_node->m_base_type, p_node->m_address);
