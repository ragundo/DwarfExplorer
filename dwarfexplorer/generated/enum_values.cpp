...
std::tuple<int64_t, std::string, std::string> get_ui_sidebar_mode_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 55: std::get<1>(result) = "anon_1"; break;
...
std::tuple<int64_t, std::string, std::string> get_unit_thought_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 245: std::get<1>(result) = "anon_3"; break;
		case 246: std::get<1>(result) = "anon_4"; break;
		case 247: std::get<1>(result) = "anon_5"; break;
		case 248: std::get<1>(result) = "anon_6"; break;
		case 249: std::get<1>(result) = "anon_7"; break;
		case 250: std::get<1>(result) = "anon_8"; break;
...
std::tuple<int64_t, std::string, std::string> get_army_controller__T_type_value_decoded(DF_Type p_base_type, uint64_t p_address)
{
	...
	switch (std::get<0>(result))
	{
		...
		case 17: std::get<1>(result) = "t17"; break;
		...
		case 24: std::get<1>(result) = "t24"; break;
		default: break;
	}
	return result;
}
